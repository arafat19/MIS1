...
/**
 *  Show UI for accVoucherTypeCoa CRUD and list of accVoucherTypeCoa objects for grid
 *  For details go through Use-Case doc named 'ShowAccVoucherTypeCoaActionService'
 */
class ShowAccVoucherTypeCoaActionService extends BaseService implements ActionIntf {

    private static final String DEFAULT_ERROR_MESSAGE = "Failed to load voucher type page"
    ...
    /**
     * get list of accVoucherTypeCoa object(s)
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map resultMap = listVoucherTypeCoa()
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List resultList = wrapListInGridEntityList(voucherTypeCoaList, start)
    ...
    private static final String COUNT_QUERY = """
               ...
               WHERE acc_chart_of_account.company_id =:companyId
        """
    /**
     * get list of accVoucherTypeCoa object(s) for grid
     * @return -map contains list of groovyRowResult and count
     */
    private Map listVoucherTypeCoa() {
        String strQuery = """
