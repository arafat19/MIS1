...
class AcceptInvitationDocInvitedMemberActionService extends BaseService implements ActionIntf {
    ...
    * */
    ...
    /*
    * Create User and mapping this user with selected category/sub-category
    * @param parameterMap
    * @param invitedMember object
    * @param category object
    * @param list of sub-category
    * */
    ...
    /*
   * Create mapping this user with selected category/sub-category
   * @param appuser
   * @param invitedMember object
   * @param category object
   * @param list of sub-category
   ...
   * */
    ...
    * @param parameters - a map for build mail
    * */
    ...
    * Execute Mail
    * @param appMail - AppMail object
    * @param userMailAddress - User Email Address
    * */
