...
class GetDropDownCostingTypeTagLibActionService extends BaseService implements ActionIntf {
     ...
     * @return - html string for select
     */
    private String buildDropDown(List<CostingType> lstCostingType, Map dropDownAttributes) {
        // read map values
        ...
        if (showHints.booleanValue()) {
            lstCostingType = Tools.listForKendoDropdown(lstCostingType, null, hintsText)  // the null parameter indicates that dataTextField is name
        }
        String jsonData = lstCostingType as JSON
