...
/*
 * Download group ledger in pdf format
 * For details go through Use-Case doc named 'DownloadForGroupLedgerActionService'
 */
class DownloadForGroupLedgerActionService extends BaseService implements ActionIntf {
    ...
    private static final String ACC_LEDGER_REPORT_SINGLE = 'accGroupLedger.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            //if postedByParam  = 0 then it will show Only Posted Voucher
            //if postedByParam  = -1 then it will both Posted & Unposted Voucher
            ...
            Map report = getGroupLedgerReport(accGroup, fromDate, toDate, projectIds, postedByParam)  // get group ledger PDF report
    ...
    private Map getGroupLedgerReport(AccGroup accGroup, Date fromDate, Date toDate, List projectIds, long postedByParam) {
        ...
        JasperReportDef reportDef = new JasperReportDef(name: ACC_LEDGER_REPORT_SINGLE, fileFormat: JasperExportFormat.PDF_FORMAT,
