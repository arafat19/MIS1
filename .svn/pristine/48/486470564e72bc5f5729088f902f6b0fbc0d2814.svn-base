...
/**
 * Download remittance transaction report in pdf format for Admin or Cashier
 * For details go through Use-Case doc named 'ExhDownloadTransactionSummaryActionService'
 */
class ExhDownloadRemittanceTransactionActionService extends BaseService implements ActionIntf {
    ...
    private static final String JASPER_FILE = 'remittanceTransaction.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            GrailsParameterMap params = (GrailsParameterMap) parameters
            Map report = getRemittanceTransactionReport(params)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
     ...
     */
    private Map getRemittanceTransactionReport(GrailsParameterMap params) {

        String reportDir = Tools.getExchangeHouseReportDirectory() + File.separator + REPORT_FOLDER
        String outputFileName = OUTPUT_FILE_NAME + PDF_EXTENSION               // set file name with pdf extension
