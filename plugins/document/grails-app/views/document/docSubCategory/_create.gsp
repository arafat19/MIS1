    ...
    <form id='subCategoryForm' name='subCategoryForm' class="form-horizontal form-widgets" role="form" method="post">
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="isEmailNotification">Email Notification:</label>

                        <div class="col-md-1">
                            <g:checkBox tabindex="4" name="isEmailNotification"/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="panel-footer">
            ...
            <button id="clearFormButton" name="clearFormButton" type="button" data-role="button"
                    ...
                    aria-disabled="false" onclick='resetSubCategoryForm();'><span class="k-icon k-i-close"></span>Cancel
            </button>
        </div>
    </form>
</div>
