...
class DocSubCategoryUserMappingService extends BaseService {
    ...
    public int countByCompanyIdAndCategoryIdAndSubCategoryId(DocSubCategory subCategory) {
        int countSubCategoryUserMapping = DocSubCategoryUserMapping.countByCompanyIdAndCategoryIdAndSubCategoryId(subCategory.companyId, subCategory.categoryId, subCategory.id)
        return countSubCategoryUserMapping
    }
    ...
    private static final String INSERT_QUERY = """
        INSERT INTO doc_sub_category_user_mapping
            ...
            VALUES(
            NEXTVAL('doc_sub_category_user_mapping_id_seq'),
            :version,
            :userId,
            :categoryId,
            :subCategoryId,
            :isSubCategoryManager,
            :isFavourite,
            :companyId,
            :createdOn,
            :createdBy,
