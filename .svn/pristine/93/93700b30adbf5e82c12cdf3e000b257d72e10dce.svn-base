...
/**
 * List of Fixed Asset Details.
 * For details go through Use-Case doc named 'ListFixedAssetDetailsActionService'
 */
class ListFixedAssetDetailsActionService extends BaseService implements ActionIntf {
