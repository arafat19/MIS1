<script type="text/javascript">
    ...
    function onLoadSendTask() {
        ...
        loadNumberedMenu(MENU_ID_SARB, "#sarbTaskModel/showForRefundTask");
    }
    ...
    function initFlex() {
        ...
        (
                {
                    url: "${createLink(controller: 'sarbTaskModel', action: 'listForRefundTask')}",
                    dataType: 'json',
                    colModel: [
                    ...
                    buttons: [
                        <sec:access url="/sarbTaskModel/sendRefundTaskToSarb">
                        {name: 'Send To SARB', bclass: 'send', onpress: sendRefundTaskToSarb},
                        {separator: true},
                        </sec:access>
    ...
    function sendRefundTaskToSarb(com, grid) {
        ...
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: "${createLink(controller: 'sarbTaskModel',action: 'sendRefundTaskToSarb')}?id=" + ids,
