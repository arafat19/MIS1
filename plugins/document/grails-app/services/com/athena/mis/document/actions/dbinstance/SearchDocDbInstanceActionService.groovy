...
class SearchDocDbInstanceActionService extends BaseService implements ActionIntf {
    ...
    /**
     * get the list of DB Instance for related query
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            Map searchResult = docDbInstanceCacheUtility.search(queryType, query, this)
            List<DocDbInstance> lstDbInstance = (List<DocDbInstance>) searchResult.list
