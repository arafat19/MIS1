...
<div id="application_top_panel" class="panel panel-primary">
    ...
    <app:systemEntityByReserved name="hidCashCollectionId"
                                reservedId="${RmsPaymentMethodCacheUtility.CASH_COLLECTION_ID}"
                                typeId="${RmsPaymentMethodCacheUtility.ENTITY_TYPE}">
    </app:systemEntityByReserved>
    <app:systemEntityByReserved name="hidBankDepositId" reservedId="${RmsPaymentMethodCacheUtility.BANK_DEPOSIT_ID}"
                                typeId="${RmsPaymentMethodCacheUtility.ENTITY_TYPE}">
    </app:systemEntityByReserved>
        ...
        <div class="panel-body">
            <div class="col-md-7">
                <div class="form-group">
                    <label class="col-md-4 control-label label-required" id="lblPaymentMethod"
                ...
                <div class="form-group">
                    <label class="col-md-4 control-label label-required" for="exchangeHouseId">Exchange House:</label>
            ...
            <div class="col-md-5">
                <div class="panel panel-danger" id="errorDiv" style="display: none">
                    <div class="panel-heading">
                        <div class="panel-title">
