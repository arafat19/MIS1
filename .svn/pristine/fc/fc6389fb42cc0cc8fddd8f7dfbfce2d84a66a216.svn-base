...
/**
 *  Search receive cash voucher and show specific list of receive cash voucher
 *  For details go through Use-Case doc named 'SearchAccVoucherReceiveCashActionService'
 */
class SearchAccVoucherReceiveCashActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get receive cash voucher list for grid through specific search
    ...
    /**
     * Wrap receive cash voucher  list for grid
