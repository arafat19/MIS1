...
/**
 *  Show list of financial statement of level 4 (show coa of tier1, tier2, tier3(if any) and sum of tier4) for grid
 *  For details go through Use-Case doc named 'ListForFinancialStatementOfLevel4ActionService'
 */
class ListForFinancialStatementOfLevel4ActionService extends BaseService implements ActionIntf {
     ...
     * @param parameters - serialized parameters from UI
     * @param obj - N/A
     * @return -a map containing all financial statement list for level 4 and isError(true/false)
     */
    ...
    /**
     * Get list of financial statement of level 4 for showing in the grid
    ...
    /**
     * Wrap list of income statement of level 4 in grid entity
