 ...
 *  For details go through Use-Case doc named 'ExhSearchCustomerForAgentActionService'
 */
class ExhSearchCustomerForAgentActionService extends BaseService implements ActionIntf {
    ...
    Object execute(Object params, Object obj) {
        ...
        try {
            ...
            List<GroovyRowResult> lstCustomers  = (List<GroovyRowResult>) resultList.customerList
    ...
    private List wrapCustomers(List<GroovyRowResult> lstCustomers, int start) {
        ...
        for (int i = 0; i < lstCustomers.size(); i++) {
            ...
            obj.id = customer.id
            String dateOfBirth = DateUtility.getDateFormatAsString(customer.date_of_birth)
            obj.cell = [
                    counter,
                    customer.code,
