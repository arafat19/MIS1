...
/**
 * Search rms task for disburse cash collection
 * for details go through use-case named "SearchDisburseCashCollectionTaskActionService"
 */
class SearchDisburseCashCollectionTaskActionService extends BaseService implements ActionIntf {
    ...
    private static final String IS_DISBURSABLE = "isDisbursable"
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            Boolean isDisbursable = Boolean.TRUE      // default value
            if (rmsTask.currentStatus != statusApproved.id) {
                isDisbursable = Boolean.FALSE
            }
            ...
            result.put(IS_DISBURSABLE, isDisbursable)
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Boolean isDisbursable = (Boolean) preResult.get(IS_DISBURSABLE)
            result.put(TASK_OBJECT, rmsTask)
            result.put(TASK_ID, taskId)
            result.put(ID_TYPE, rmsTask.identityType)
            result.put(ID_NO, rmsTask.identityNo)
            result.put(IS_DISBURSABLE, isDisbursable)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            return result
        } catch (Exception ex) {
