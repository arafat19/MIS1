...
class SarbTaskModelController {
    ...
    UpdateTaskForReplaceTaskActionService updateTaskForReplaceTaskActionService
    ...
    def updateTaskForReplaceTask() {
        Map result
        Boolean isError
        Map executeResult = (Map) updateTaskForReplaceTaskActionService.execute(params, null)
        isError = executeResult.isError
        if(isError.booleanValue()) {
            result = (Map) updateTaskForReplaceTaskActionService.buildFailureResultForUI(executeResult)
        } else {
