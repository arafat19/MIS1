...
/**
 * Download CSV Report of Consumption Deviation
 * For details go through Use-Case doc named 'DownloadForConsumptionDeviationCsvActionService'
 */
class DownloadForConsumptionDeviationCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Failed to download consumption deviation csv report"
    ...
    private static final String REPORT_NAME = 'consumptionDeviationCsv.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getConsumptionDeviationReport(project)
     ...
     * @return - generated CSV report with required params
     */
    private Map getConsumptionDeviationReport(Project project) {
        ...
        JasperReportDef reportDef = new JasperReportDef(name: REPORT_NAME, fileFormat: JasperExportFormat.CSV_FORMAT,
