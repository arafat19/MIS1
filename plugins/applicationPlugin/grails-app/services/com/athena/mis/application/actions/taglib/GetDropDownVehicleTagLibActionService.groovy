...
class GetDropDownVehicleTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<Vehicle> lstVehicle = vehicleCacheUtility.list()
            String html = buildDropDown(lstVehicle, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
    ...
    private String buildDropDown(List<Vehicle> lstVehicle, Map dropDownAttributes) {
        ...
        if (showHints.booleanValue()) {
            lstVehicle = Tools.listForKendoDropdown(lstVehicle, null, hintsText)  // the null parameter indicates that dataTextField is name
        }
