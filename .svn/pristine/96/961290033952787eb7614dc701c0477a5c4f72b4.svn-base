...
<g:render template="/arms/report/taskDetails/scriptTaskDetailsWithNote" />
<div id="application_top_panel" class="panel panel-primary">
    ...
    <g:formRemote name='taskDetailsForm' class="form-horizontal form-widgets" role="form"
                  update="divTaskDetailsWithNote" method="post"
                  before="if (!executePreConditionForSearchTask()) {return false;}"
                  onComplete="executePostConditionForSearchTask()"
                  url="${[controller: 'rmsTask', action: 'searchTaskDetailsWithNote']}">
...
<div id="divTaskDetailsWithNote">
    <g:render template="/arms/rmsTask/taskDetailsWithNote"/>
</div>