...
/**
 *  Show UI for accTier3 CRUD and list of accTier3 objects for grid
 *  For details go through Use-Case doc named 'ShowAccTier3ActionService'
 */
class ShowAccTier3ActionService extends BaseService implements ActionIntf {

    private Logger log = Logger.getLogger(getClass())

    private static final String DEFAULT_ERROR_MESSAGE = "Failed to load tier-3 page"
    ...
    /**
     * get list of accTier3 object(s)
     * @param parameters -parameters from UI
     * @param obj -N/A
     * @return -a map contains accTier3List and count; Also AccType list for drop-down
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            initPager(params)
            //get accTier3 list for grid
            List accTier3List = accTier3CacheUtility.list(this)
            int count = accTier3CacheUtility.count()
     ...
     * @param obj -a map contains accTier3ObjectList, count & accType list
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List accTier3List = (List) executeResult.get(ACC_TIER3_LIST)
            int count = (int) executeResult.get(Tools.COUNT)
            List resultList = wrapListInGridEntityList(accTier3List, start)
            Map output = [page: pageNumber, total: count, rows: resultList]
            result.put(ACC_TIER3_LIST, output)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
