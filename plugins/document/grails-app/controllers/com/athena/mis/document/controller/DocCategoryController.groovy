...
class DocCategoryController {
    ...
    static allowedMethods = [show          : "post", create: "post", update: "post", delete: "post", list: "post", select: "post",
                             showCategories: "post", viewCategoryDetails: "post",
    ...
    * */
    ...
    def showCategories() {
        render(view: '/document/docMyCategory/show', model: [category_id: params.categoryId ? params.categoryId : 0L])
    }
    /*
    * View My Category details
    * */

    def viewCategoryDetails() {
