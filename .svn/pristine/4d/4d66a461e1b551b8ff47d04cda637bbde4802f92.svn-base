...
<script type="text/javascript">
    ...
    function onLoadVoucher() {
        ...
        // update page title
        $(document).attr('title', "MIS - Create Voucher (Receive Cash)");
        loadNumberedMenu(MENU_ID_ACCOUNTING, "#accVoucher/showReceiveCash");
    }
    ...
    function setUrlVoucherGrid() {
        var strUrl = "${createLink(controller:'accVoucher', action: 'listReceiveCash')}";
    ...
    function addInCredit(com, grid) {
        ...
        var returnObject = getSourceListByCoaCode(coaCodeCr);
        if (!returnObject) return false;
        var lstSource = returnObject.sourceList;
