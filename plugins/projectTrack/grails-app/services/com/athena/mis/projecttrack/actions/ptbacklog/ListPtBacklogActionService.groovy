 ...
 *  For details go through Use-Case doc named 'ListPtBacklogActionService'
 */
class ListPtBacklogActionService extends BaseService implements ActionIntf {
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List<GroovyRowResult> lstPtBacklog = (List) executeResult.get(LST_BACKLOG)
            Integer count = (Integer) executeResult.get(Tools.COUNT)
            List<GroovyRowResult> lstWrappedBacklogs = wrapBacklogs(lstPtBacklog, start)
