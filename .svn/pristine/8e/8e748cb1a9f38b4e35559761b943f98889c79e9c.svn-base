...
class DeleteAppUserDocSubCategoryActionService extends BaseService implements ActionIntf {
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            DocSubCategoryUserMapping docSubCategoryUserMapping = docSubCategoryUserMappingService.read(appUserSubCategoryMappingId)
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            docSubCategoryUserMappingService.delete(docSubCategoryUserMapping.companyId, docSubCategoryUserMapping.userId) //delete object from DB
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            return result
        } catch (Exception ex) {
