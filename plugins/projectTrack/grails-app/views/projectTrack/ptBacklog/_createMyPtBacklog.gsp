...
<div id="application_top_panel" class="panel panel-primary">
    ...
    <form id='myBacklogForm' name='myBacklogForm' class="form-horizontal form-widgets" role="form">
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label label-optional" for="url">URL:</label>

                <div class="col-md-8">
                    <input class="k-textbox" id="url" name="url" tabindex="4"
                           placeholder="URL" validationMessage="Required"/>
                </div>
