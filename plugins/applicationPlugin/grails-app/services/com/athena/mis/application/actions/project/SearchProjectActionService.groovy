...
/**
 *  Search project and show specific list of project for grid
 *  For details go through Use-Case doc named 'SearchProjectActionService'
 */
class SearchProjectActionService extends BaseService implements ActionIntf {

    private final Logger log = Logger.getLogger(getClass())
    private static String PAGE_LOAD_ERROR_MESSAGE = "Failed to search project grid"
    ...
    public Object execute(Object params, Object obj = null) {
        try {
            ...
            initSearchKendo(parameterMap)
            Map searchResult = projectCacheUtility.search(queryType, query, this)
            List<Project> projectList = searchResult.list
