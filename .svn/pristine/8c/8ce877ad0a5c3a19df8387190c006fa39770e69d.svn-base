...
/**
 *  Show UI for user group(appGroup) CRUD and list of user group for grid
 *  For details go through Use-Case doc named 'ShowAppGroupActionService'
 */
class ShowAppGroupActionService extends BaseService implements ActionIntf {
    ...
    private static final String APP_GROUP_LIST = "appGroupList"
    /**
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            result.put(APP_GROUP_LIST, groupList)
