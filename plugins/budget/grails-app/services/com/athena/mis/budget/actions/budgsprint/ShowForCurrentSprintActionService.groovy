...
/**
 *  Show list of current sprints of projects for grid
 *  For details go through Use-Case doc named 'ShowForCurrentSprintActionService'
 */
class ShowForCurrentSprintActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Could not load current sprint page"
