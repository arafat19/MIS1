...
/**
 *  Show list of account voucher (accVoucher) for grid
 *  For details go through Use-Case doc named 'ListAccVoucherActionService'
 */
class ListAccVoucherActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get account voucher (accVoucher) list for grid
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // Get voucher list by using dynamic finder
    ...
    /**
     * Wrap account voucher (accVoucher) list for grid
    ...
    /**
     * Wrap list of account voucher (accVoucher) in grid entity
     * @param voucherList -list of account voucher (accVoucher) object(s)
     * @param start -starting index of the page
     * @return -list of wrapped account voucher (accVoucher)(s)
     */
