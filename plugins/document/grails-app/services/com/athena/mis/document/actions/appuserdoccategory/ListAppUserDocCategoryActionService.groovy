...
class ListAppUserDocCategoryActionService extends BaseService implements ActionIntf {
     ...
     *  2.check categoryId is valid/invalid
     *  3.Get the list of user & count for category
    ...
    private static final String LST_QUERY = """
         SELECT cum.id,au.username,cum.is_category_manager
            FROM app_user au
            LEFT JOIN doc_category_user_mapping cum ON cum.user_id=au.id
