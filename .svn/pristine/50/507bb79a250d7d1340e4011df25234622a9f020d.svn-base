...
/**
 *  Show UI for accLc CRUD and list of accLc for grid
 *  For details go through Use-Case doc named 'ShowAccLcActionService'
 */
class ShowAccLcActionService extends BaseService implements ActionIntf {
    ...
    private static final String PAGE_LOAD_ERROR_MESSAGE = "Failed to load LC page"
