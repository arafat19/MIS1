        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <exh:checkSysConfig key="${ExhSysConfigurationIntf.EXH_CUSTOMER_DECLARATION_AMOUNT}" value="0">
                    ...
                    <div class="col-md-5">
                        <app:dateControl id="declarationStart" name="declarationStart"
                                         tabindex="4" placeholder="dd/MM/yyyy" value="">
                        </app:dateControl>
                    </div>
                </exh:checkSysConfig>
                ...
                <exh:checkSysConfig key="${ExhSysConfigurationIntf.EXH_CUSTOMER_DECLARATION_AMOUNT}" value="1">
                    ...
                    <div class="col-md-5">
                        ...
                        <app:dateControl id="declarationStart" name="declarationStart"
                                         tabindex="4" placeholder="dd/MM/yyyy" value="" validationMessage="Required">
                        </app:dateControl>
                    </div>
                </exh:checkSysConfig>
                <div class="col-md-3 pull-left">
            ...
            <div class="form-group">
                <exh:checkSysConfig key="${ExhSysConfigurationIntf.EXH_CUSTOMER_DECLARATION_AMOUNT}" value="0">
                    ...
                    <div class="col-md-5">
                        <app:dateControl id="declarationEnd" name="declarationEnd"
                                         tabindex="5" placeholder="dd/MM/yyyy" value="">
                        </app:dateControl>
                ...
                <exh:checkSysConfig key="${ExhSysConfigurationIntf.EXH_CUSTOMER_DECLARATION_AMOUNT}" value="1">
                    ...
                    <div class="col-md-5">
                        <app:dateControl id="declarationEnd" name="declarationEnd"
                                         tabindex="5" placeholder="dd/MM/yyyy" value="" validationMessage="Required">
                        </app:dateControl>
