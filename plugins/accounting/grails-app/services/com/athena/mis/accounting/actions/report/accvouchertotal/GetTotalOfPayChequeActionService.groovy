...
/**
 * Get sum of voucher amount (Total of Pay Cheque) on current date and send sms
 * For details go through Use-Case doc named 'GetTotalOfPayChequeActionService'
 */
class GetTotalOfPayChequeActionService extends BaseService implements ActionIntf {
    ...
    /**
     * 1. get total amount of posted voucher on current date (Total Of Pay Cheque)
     * 2. Get total amount of un-posted voucher on current date (Total Of Pay Cheque)
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            long companyId = accSessionUtil.appSessionUtil.getCompanyId()
            SystemEntity voucherTypePayBank = (SystemEntity) accVoucherTypeCacheUtility.readByReservedAndCompany(accVoucherTypeCacheUtility.PAYMENT_VOUCHER_BANK_ID, companyId)
    ...
    /**
     * Get total amount of posted voucher on current date (Total Of Pay Cheque)
     * FOR sms character 'DB_QUANTITY_FORMAT' is used instead of 'DB_CURRENCY_FORMAT'
     * @param currentDate -new date
     * @param voucherType -system entity id of voucher type pay cheque object
    ...
    /**
     * Get total amount of un-posted voucher on current date (Total Of Pay Cheque)
     * FOR sms character 'DB_QUANTITY_FORMAT' is used instead of 'DB_CURRENCY_FORMAT'
     * @param currentDate -new date
     * @param voucherType -system entity id of voucher type pay cheque object
