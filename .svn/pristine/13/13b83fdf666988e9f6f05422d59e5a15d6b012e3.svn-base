...
/**
 *  Download Inventory Status report in PDF format
 *  For details go through Use-Case doc named 'DownloadForInventoryStatusWithQuantityAndValuePdfActionService'
 */
class DownloadForInventoryStatusWithQuantityAndValuePdfActionService extends BaseService implements ActionIntf {
    ...
    private static final String JASPER_FILE = 'inventoryStatus.jasper'
