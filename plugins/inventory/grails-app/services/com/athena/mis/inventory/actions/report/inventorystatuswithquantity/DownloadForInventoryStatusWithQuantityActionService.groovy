...
/**
 *  Download Inventory Status with quantity report in PDF format
 *  For details go through Use-Case doc named 'DownloadForInventoryStatusWithQuantityActionService'
 */
class DownloadForInventoryStatusWithQuantityActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'inventoryStatusWithQuantity'
    ...
    private static final String REPORT_TITLE = 'Inventory Status With Quantity'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'inventoryStatusWithQuantity.jasper'
