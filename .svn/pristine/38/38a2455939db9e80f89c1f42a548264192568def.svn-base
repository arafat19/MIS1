...
class UpdateMyPtBacklogActionService extends BaseService implements ActionIntf {
    ...
    private static final String URL_REQUIRED = "URL required"
    ...
    private final static String URL_EXIST_MESSAGE = "Same URL already exists"
    ...
    public Object executePreCondition(Object params, Object obj) {
        ...
        try {
            ...
            if (statusId == ptBacklogStatusCompleted.id) {
                //checking how many acceptance criteria remaining for being accepted
                ...
                if (parameterMap.url == '') {
                    result.put(Tools.MESSAGE, URL_REQUIRED)
                    return result
                }
            }
            ...
            int countUrl = PtBacklog.countByUrlAndIdNotEqual(backlog.url, backlog.id)
            if (countUrl > 0) {
                result.put(Tools.MESSAGE, URL_EXIST_MESSAGE)
                return result
            }
