...
/**
 *  Get list of taskList for specific search
 *  For details go through Use-Case doc named 'SearchTaskListForSearchActionService'
 */
class SearchTaskListForSearchActionService extends BaseService implements ActionIntf {
    ...
    private Map mapTaskListForSearch(Date fromDate, Date toDate, BaseService baseService) {
        String queryStr = """
            ...
            WHERE task_list.created_on BETWEEN :fromDate AND :toDate
                ...
                AND ${baseService.queryType} LIKE :query
