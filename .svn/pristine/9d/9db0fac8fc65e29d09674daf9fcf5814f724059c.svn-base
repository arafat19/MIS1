...
/*
 * Show project wise list of items with total budget quantity and total pr quantity
 * For details go through Use-Case doc named 'ListForProjectBudgetActionService'
 */
class ListForProjectBudgetActionService extends BaseService implements ActionIntf {
    ...
    private static final String NOT_FOUND_MSG = "Budget not found with this Project"
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            List<BudgetProjectItemModel> lstProjectItem = BudgetProjectItemModel.findAllByProjectId(projectId, [offset: start, max: resultPerPage, sort: 'itemName', order: 'asc'])
            int count = BudgetProjectItemModel.countByProjectId(projectId)
            if (count <= 0) {
