 ...
 */
class CreateItemCategoryNonInvActionService extends BaseService implements ActionIntf {
    ...
    private Item buildItemObject(GrailsParameterMap parameterMap) {
        ...
        SystemEntity nonInvItemSysEntityObject = (SystemEntity) itemCategoryCacheUtility.readByReservedAndCompany(itemCategoryCacheUtility.NON_INVENTORY, item.companyId)
        item.categoryId = nonInvItemSysEntityObject.id
