...
/**
 * Send cancel task to SARB
 * for details go through use-case named "SendCancelTaskToSarbActionService"
 */
class SendCancelTaskToSarbActionService extends BaseService implements ActionIntf {
    ...
    */
    ...
    private SarbTaskDetails buildSarbTaskDetails(SarbTaskModel taskModel) {
        SystemEntity movedForCanceled = (SystemEntity) sarbTaskReviseStatusCacheUtility.readByReservedAndCompany(SarbTaskReviseStatusCacheUtility.MOVED_FOR_CANCEL, sarbSessionUtil.appSessionUtil.getCompanyId())
        ...
        sarbTaskDetails.reviseStatus = movedForCanceled.id
        sarbTaskDetails.isCancelled = Boolean.TRUE
