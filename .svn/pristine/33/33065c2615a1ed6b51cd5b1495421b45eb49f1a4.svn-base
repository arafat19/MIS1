...
/**
 *  Class to get list of entityContent(attachment) objects to show on grid
 *  For details go through Use-Case doc named 'ListEntityContentActionService'
 */
class ListEntityContentActionService extends BaseService implements ActionIntf {
    ...
    /**
     * get list of entityContent(attachment) objects
     * @param parameters -parameters from UI
     * @param obj -N/A
     * @return -a map contains list of entityContent(attachment) objects  and count
     ...
     * @param obj -a map contains entityContent(Project attachment) objects list and count
