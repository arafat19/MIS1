...
/**
 * Download inventory valuation report in pdf format
 * For details go through Use-Case doc named 'DownloadForInventoryValuationActionService'
 */
class DownloadForInventoryValuationActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Fail to generate Inventory Valuation Report"
    ...
    private static final String JASPER_FILE = 'inventoryValuation.jasper'
