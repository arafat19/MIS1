...
/**
 * Download  financial statement in PDF or Excel format for level 3
 * Report will contain  coa of tier1 & tier2(if any) and sum of tier3
 * For details go through Use-Case doc named 'DownloadForFinancialStatementOfLevel3ActionService'
 */
class DownloadForFinancialStatementOfLevel3ActionService extends BaseService implements ActionIntf {
    ...
    private static final String REPORT_FOLDER = 'accFinancialStatement' + File.separator + 'level3'
    private static final String OUTPUT_FILE_NAME = 'accFinancialStatementOfLevel3'
    private static final String REPORT_TITLE = 'accFinancialStatementOfLevel3'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String SUBREPORT_DIR = 'SUBREPORT_DIR'
    private static final String REPORT = "report"
    private static final String ACC_FINANCIAL_STATEMENT_REPORT = 'accFinancialStatementOfLevel3.jasper'
