...
/**
 *  Search specific list of orphan bug
 *  For details go through Use-Case doc named 'SearchOrphanBugActionService'
 */
class SearchOrphanBugActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get list of orphan bug by specific search key word
    ...
    private Map search() {
        ...
        List<GroovyRowResult> lstBugs = executeSelectSql(strQuery, queryParams)
