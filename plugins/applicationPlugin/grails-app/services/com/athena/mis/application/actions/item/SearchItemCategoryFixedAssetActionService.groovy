...
/**
 *  Class to get search result list of itemObject (Category : FixedAsset) to show on grid
 *  For details go through Use-Case doc named 'SearchItemCategoryFixedAssetActionService'
 */
class SearchItemCategoryFixedAssetActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            if ((!parameterMap.sortname) || (parameterMap.sortname.toString().equals(ID))) {
                ...
                parameterMap.sortorder = itemCacheUtility.SORT_ORDER_ASCENDING
            }
            initSearch(parameterMap)
            Map searchResult = itemCacheUtility.searchCategoryWiseItemList(queryType, query, itemCategoryCacheUtility.FIXED_ASSET, this)
