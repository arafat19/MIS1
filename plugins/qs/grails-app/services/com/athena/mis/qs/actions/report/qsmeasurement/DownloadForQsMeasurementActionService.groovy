...
/**
 * Download PDF report of QS Measurement
 * For details go through Use-Case doc named 'DownloadForQsMeasurementActionService'
 */
class DownloadForQsMeasurementActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'qsMeasurement'
    private static final String REPORT_TITLE = 'QS Measurement Report'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'qsMeasurement.jasper'
    ...
    /**
     * Generate QS Measurement pdf report
