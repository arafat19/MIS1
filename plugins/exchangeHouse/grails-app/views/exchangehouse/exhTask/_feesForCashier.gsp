...
<div class="col-md-6">
	...
	<div class="form-group">
		<label class="col-md-4 control-label" id="lblLocalCurrency" for="lblAmountInLocalCurrency">Amount:</label>
        <span id="lblAmountInLocalCurrency" class="col-md-3">0.00</span>

        <span id="lblAmountInForeignCurrency" class="col-md-5">[BDT 0.00]</span>
	...
	<div class="form-group">
		...
		<div class="col-md-5">
			<app:dropDownSystemEntity class="required valueSelection" tabindex="26"
			                          name="paidBy"
			                          ...
			                          elements="${[
					                          ...
					                          ExhPaidByCacheUtility.PAID_BY_ID_PAY_POINT,
	...
	<div id="paidByNoSpan" style="display: none">
		<div class="form-group">
			<label class="col-md-4 control-label label-required" for="paidByNo" id="lblPaidByNo">Transaction No:</label>
...
<div class="col-md-6">
			...
			<div class="row">
				<div class="col-md-6">
					<exh:dropDownCurrencyConversion dataModelName="dropDownCurrency" name="fromCurrencyId"
					                                tabindex="20" showHints="false"
					                                onchange="return setConversionRate()">
					</exh:dropDownCurrencyConversion>
				</div>

				<div class="col-md-6" style="padding: 0">
					<input type="text" class="k-textbox" tabindex="21"
	...
	<div class="form-group">
		<label class="col-md-5 control-label label-required" for="conversionRate">Discount:</label>

		<div class="col-md-7">
			<div class="row">

				<div class="col-md-6">
					<input type="text" class="k-textbox" name="discount" id="discount"
					       required="true" validationMessage=" " value="0.00" tabindex="23"/>
				</div>
	...
	<div class="form-group">
		<label class="col-md-5 control-label label-optional" for="givenAmount">Given Amount:</label>

		<div class="col-md-7">
			<div class="row">
				<div class="col-md-6">
					<input type="text" class="k-textbox" name="givenAmount" id="givenAmount"
					       value="" tabindex="24"/>
				</div>

				<div class="col-md-4" style="padding: 0">
					<input type='button' tabindex="25" name="grandTotalLink" id="grandTotalLink"
					       class="k-button"
					       value="Calculate"
	...
	<div class="form-group">
		<label class="col-md-5 control-label" for="lblTotal">Change:</label>
		<span id="lblChange" class="col-md-5">0.00</span>
	</div>
