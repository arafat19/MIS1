 ...
 *  For details go through Use-Case doc named 'ShowSmsActionService'
 */
class ShowSmsActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            List smsList = smsService.findAllByCompanyIdAndPluginId(companyId, pluginId)
