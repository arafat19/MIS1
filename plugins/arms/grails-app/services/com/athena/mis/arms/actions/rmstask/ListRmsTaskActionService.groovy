...
/**
 *  Get list of Task
 *  For details go through Use-Case doc named 'ListRmsTaskActionService'
 */
class ListRmsTaskActionService extends BaseService implements ActionIntf {
    ...
    private static final String SHOW_TASK_FAILURE_MESSAGE = "Failed to load task page"
    ...
    Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            result.put(Tools.MESSAGE, SHOW_TASK_FAILURE_MESSAGE)
            return result
        }
    }
    ...
    private List<GroovyRowResult> list(BaseService baseService, boolean isExhUser, long status) {
        ...
        String strStatus = "AND task.current_status = ${status}"
        if(isExhUser) {
