...
class GetDropDownSupplierTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<Supplier> lstSupplier = supplierCacheUtility.list()
            String html = buildDropDown(lstSupplier, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
    ...
    private String buildDropDown(List<Supplier> lstSupplier, Map dropDownAttributes) {
        ...
        if (showHints.booleanValue()) {
            lstSupplier = Tools.listForKendoDropdown(lstSupplier, null, hintsText)  // the null parameter indicates that dataTextField is name
        }
