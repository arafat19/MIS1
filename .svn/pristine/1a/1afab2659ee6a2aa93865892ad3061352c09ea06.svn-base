 ...
 * For details go through Use-Case doc named 'DownloadForInventorySupplierchalanCsvActionService'
 */
class DownloadForInventorySupplierchalanCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'supplierChalan'
    ...
    private static final String JASPER_FILE_FOR_ALL_OR_ACKNOWLEDGED = 'supplierChalanCSVForAllOrAcknowledged.jasper'
    private static final String JASPER_FILE_FOR_PENDING = 'supplierChalanCSVForPending.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            // generate report
            Map report = getInventorySupplierChalanCsvReport(chalanNo, supplierId, status, statusStr, supplierName)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
    ...
    /**
     * Generate supplier chalan report in csv format
     ...
     */
    private Map getInventorySupplierChalanCsvReport(String chalanNo, long supplierId, int status, String statusStr, String supplierName) {
        ...
        JasperReportDef reportDef = new JasperReportDef(name: fileName, fileFormat: JasperExportFormat.CSV_FORMAT,
