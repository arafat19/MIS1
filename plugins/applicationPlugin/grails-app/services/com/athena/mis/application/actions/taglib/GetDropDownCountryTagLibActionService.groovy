...
class GetDropDownCountryTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            dropDownAttributes.put(TEXT_MEMBER, NAME)
            ...
            if (attrs.textMember) {
                dropDownAttributes.put(TEXT_MEMBER, attrs.textMember)
            }
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<Country> lstCountry = countryCacheUtility.list()
            String html = buildDropDown(lstCountry, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
     ...
     * @return - html string for select
     */
    private String buildDropDown(List<Country> lstCountry, Map dropDownAttributes) {
        // read map values
        ...
        if (showHints.booleanValue()) {
            lstCountry = Tools.listForKendoDropdown(lstCountry, textMember, hintsText)  // the null parameter indicates that dataTextField is name
        }
