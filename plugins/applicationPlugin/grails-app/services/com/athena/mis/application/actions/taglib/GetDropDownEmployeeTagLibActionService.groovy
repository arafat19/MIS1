...
class GetDropDownEmployeeTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<Employee> lstEmployee = employeeCacheUtility.list()
            String html = buildDropDown(lstEmployee, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
     ...
     * @return - html string for select
     */
    private String buildDropDown(List<Employee> lstEmployee, Map dropDownAttributes) {
        // read map values
        ...
        if (showHints.booleanValue()) {
            lstEmployee = Tools.listForKendoDropdown(lstEmployee, FULL_NAME, hintsText)  // the FULL_NAME parameter indicates that dataTextField is fullName
        }
