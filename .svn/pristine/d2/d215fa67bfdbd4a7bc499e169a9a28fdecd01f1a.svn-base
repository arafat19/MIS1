...
/**
 * supplier-wise payment details in in csv format.
 * For details go through Use-Case doc named 'DownloadForSupplierWisePaymentCsvActionService'
 */
class DownloadForSupplierWisePaymentCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String SUPPLIER_WISE_PAYMENT_REPORT_CSV = 'accSupplierWisePaymentCSV.jasper'
    ...
    private Map getSupplierPoReport(Supplier supplier, List lstProjectIds, String projectName, Date fromDate, Date toDate, String paidTotal, long postedByParam) {
        ...
        JasperReportDef reportDef = new JasperReportDef(name: SUPPLIER_WISE_PAYMENT_REPORT_CSV, fileFormat: JasperExportFormat.CSV_FORMAT,
