...
/**
 *  Show UI for accIpc CRUD and list of accIpc for grid
 *  For details go through Use-Case doc named 'ShowAccIpcActionService'
 */
class ShowAccIpcActionService extends BaseService implements ActionIntf {
