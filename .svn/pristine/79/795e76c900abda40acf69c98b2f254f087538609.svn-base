<script type="text/javascript">
    ...
    function showTaskDetails(data) {
        ...
        try {
            ...
            $('#accountNumber').text(taskMap.accountNumber);
            $('#beneficiaryBankInfo').text(taskMap.beneficiaryBankInfo);
            showLoadingSpinner(false);
        } catch (e) {
            showLoadingSpinner(false);
        }
        ...
        <tr>
            <td width="50%" style="padding: 0">
                <table width="100%" style="margin-bottom: 0" class="table">
                    ...
                    <tr>
                        ...
                        <td id="mappingBankInfo"
                            style="font-weight: bold;color:#0000ff"></td>
                    </tr>
                </table>
            </td>
            <td width="50%" valign="top" style="padding: 0">
                ...
                <table style="border-bottom: 1px solid #DDDDDD" class="table">
                    ...
                    <tr>
                        <td class='active' nowrap="nowrap">Account Number:</td>
                        <td id="accountNumber"></td>
                    </tr>
                    <tr>
                        <td class='active' nowrap="nowrap">Beneficiary Bank:</td>
                        <td id="beneficiaryBankInfo"></td>
                    </tr>
                </table>
            </td>
        </tr>
