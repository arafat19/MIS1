...
/**
 *  Show UI for ContentCategory CRUD and list of ContentCategory for grid
 *  For details go through Use-Case doc named 'ShowContentCategoryActionService'
 */
class ShowContentCategoryActionService extends BaseService implements ActionIntf {
    ...
    private static final String SHOW_FAILURE_MESSAGE = "Failed to load content category page"
    private static final String LST_CONTENT_CATEGORY = "lstContentCategory"

    /**
     * Check if user has access to view ContentCategory
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            // only development role type user can view ContentCategory
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            int count = contentCategoryCacheUtility.count() // get count of total ContentCategory
