...
class GetDropDownAppGroupTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<AppGroup> lstAppGroup = appGroupCacheUtility.list()
            String html = buildDropDown(lstAppGroup, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
    ...
    private String buildDropDown(List<AppGroup> lstAppGroup, Map dropDownAttributes) {
        ...
        if (showHints.booleanValue()) {
            lstAppGroup = Tools.listForKendoDropdown(lstAppGroup, null, hintsText)  // the null parameter indicates that dataTextField is name
        }
