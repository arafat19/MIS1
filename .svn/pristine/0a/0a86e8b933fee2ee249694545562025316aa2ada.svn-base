...
/**
 *  Show list of EntityNote for grid
 *  For details go through Use-Case doc named 'ListEntityNoteActionService'
 */
class ListEntityNoteActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Wrap EntityNote objects list in grid entity
