...
class PtBacklogService extends BaseService {
    ...
    private static final String INSERT_QUERY = """
        INSERT INTO pt_backlog(id, version, idea, actor, purpose, benefit, priority_id, status_id, hours, owner_id,
            module_id, sprint_id, company_id, created_by, created_on, updated_by, updated_on, accepted_by,
            accepted_on, use_case_id, url)
        VALUES (NEXTVAL('pt_backlog_id_seq'), :version, :idea, :actor, :purpose, :benefit, :priorityId, :statusId,
            :hours, :ownerId, :moduleId, :sprintId, :companyId, :createdBy, :createdOn, :updatedBy, :updatedOn,
            :acceptedBy, :acceptedOn, :useCaseId, :url);
	"""
    ...
    public List<PtBacklog> findAllByModuleIdAndSprintIdAndCompanyId(long moduleId, long sprintId, long companyId) {
        List<PtBacklog> lstBackLogs = PtBacklog.findAllByModuleIdAndSprintIdAndCompanyId(moduleId, sprintId, companyId)
        return lstBackLogs
    }
    ...
    public PtBacklog findByUrlIlike(String url) {
        PtBacklog backlog = PtBacklog.findByUrlIlike(url)
        return backlog
    }
}
