...
/**
 *  Download Inventory item received (from supplier) stock status report in PDF format
 *  For details go through Use-Case doc named 'DownloadForItemReceivedStockActionService'
 */
    class DownloadForGroupByItemReceivedStockActionService extends BaseService implements ActionIntf {
        ...
        private static final String OUTPUT_FILE_NAME = 'received-stock-group-by-supplier'
        private static final String REPORT_NAME_FIELD = 'REPORT_NAME'
        private static final String REPORT_TITLE = 'Item Received Stock'
        private static final String REPORT_DIR = 'REPORT_DIR'
        private static final String JASPER_FILE_PDF = 'itemReceivedGroupBySupplier.jasper'
        ...
        private Map getInventoryStockReport(List<Long> lstProjectIds, List<Long> lstSupplierIds, String projectName, Date fromDate, Date toDate, List<Long> lstItemTypeIds, String itemTypeName) {
            ...
            long companyId = invSessionUtil.appSessionUtil.getCompanyId()
            String fromDateStr = DateUtility.getLongDateForUI(fromDate)
            String toDateStr = DateUtility.getLongDateForUI(toDate)
            ...
            reportParams.put(DATE_RANGE, fromDateStr + Tools.TO + toDateStr)
