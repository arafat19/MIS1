 ...
 *  For details go through Use-Case doc named 'DownloadForInventoryStatusWithValueCsvActionService'
 */
class DownloadForInventoryStatusWithValueCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'inventoryStatusWithValueCsv'
    ...
    private static final String REPORT_TITLE = 'Inventory Status With Value Csv'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'inventoryStatusWithValueCsv.jasper'
