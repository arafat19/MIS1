...
class GetDropDownExhPhotoIdTypeTagLibActionService {
    @Autowired
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<ExhPhotoIdType> lstPhotoIdType = exhPhotoIdTypeCacheUtility.list()
            String html = buildDropDown(lstPhotoIdType, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
     ...
     * @param lstPhotoIdType - list for select 'options'
     * @param dropDownAttributes - a map containing the attributes of drop down
     * @return - html string for select
     */
    private String buildDropDown(List<ExhPhotoIdType> lstPhotoIdType, Map dropDownAttributes) {
        // read map values
        ...
        {
            lstPhotoIdType = Tools.listForKendoDropdown(lstPhotoIdType,null,null)
        }
        String jsonData = lstPhotoIdType as JSON
        String script = """ \n
