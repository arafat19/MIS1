<div id="application_top_panel" class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">
            <span id="subCategoryLabel"></span> Details
        </div>
    </div>
    ...
    <form id='subCategoryForm' name='subCategoryForm' class="form-horizontal form-widgets" role="form" method="post">
        <div class="panel-body">
            <div class="form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="subCategoryName">Sub Category Name:</label>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="subCategoryDescription">Description:</label>

                        <div class="col-md-10">
                            <span id="subCategoryDescription"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="categoryDescription">Description:</label>
...
<div class="container-fluid">
    ...
    <div class="row panel panel-primary" id="applyForSubCategoryMembershipDiv" style="display: none">
        <div class="panel-heading">
            <div class="panel-title">
        ...
        <form onsubmit=""
              action='${createLink(controller: 'docMemberJoinRequest', action: 'applyForSubCategoryMembership')}'
