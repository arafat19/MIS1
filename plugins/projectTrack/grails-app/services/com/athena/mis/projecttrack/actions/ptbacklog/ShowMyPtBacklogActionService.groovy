...
/**
 *  Show UI for ptBacklog CRUD and list of ptBacklog for grid in MyBacklog
 *  For details go through Use-Case doc named 'ShowMyPtBacklogActionService'
 */
class ShowMyPtBacklogActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_FAILURE_MSG_SHOW_MY_BACKLOG = "Failed to load my backlog page"
    ...
    /**
     * Get ptBacklog list for grid in My Backlog
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            result.put(Tools.IS_ERROR, Boolean.TRUE)
            result.put(Tools.MESSAGE, DEFAULT_FAILURE_MSG_SHOW_MY_BACKLOG)
            return result
        }
    }
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List lstWrappedBacklogs = wrapMyBacklogs(lstBacklog, start)
    ...
    /**
     * Wrap list of ptBacklog in grid entity for MyBacklog
     * @param lstBacklog -list of ptBacklog object(s)
     * @param start -starting index of the page
     * @return -list of wrapped ptBacklogs
     */
    private List wrapMyBacklogs(List<GroovyRowResult> lstBacklog, int start) {
    ...
    private LinkedHashMap listMyPtBacklog() {
        ...
        String queryStr = """
            SELECT backlog.id,backlog.actor,backlog.benefit,backlog.hours,backlog.idea,backlog.purpose,
                ...
                (SELECT COUNT(pbug.id) FROM pt_bug pbug WHERE pbug.status IN (${statusReopened.id},${statusSubmitted.id})
