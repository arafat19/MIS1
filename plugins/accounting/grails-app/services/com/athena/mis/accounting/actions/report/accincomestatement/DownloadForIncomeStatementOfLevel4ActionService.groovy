 ...
 */
class DownloadForIncomeStatementOfLevel4ActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'accIncomeStatementOfHierarchy4'
    private static final String REPORT_TITLE = 'accIncomeStatementOfHierarchy4'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String SUBREPORT_DIR = 'SUBREPORT_DIR'
    private static final String REPORT = "report"
    private static final String ACC_INCOME_STATEMENT_REPORT = 'accIncomeStatementOfHierarchy4.jasper'
    ...
    private Map getIncomeStatementSum(Date fromDate, Date toDate, List<Long> projectIds, List<Long> divisionIdList, long postedByParam) {
        String lstProjectId = Tools.buildCommaSeparatedStringOfIds(projectIds)    // e.g - (2,3,4,5)
