...
/**
 *  Delete inventory transaction object(Inventory In From Supplier) from DB and remove it from grid
 *  For details go through Use-Case doc named 'DeleteForInventoryInFromSupplierActionService'
 */
class DeleteForInventoryInFromSupplierActionService extends BaseService implements ActionIntf {
    ...
    private static final String ITEM_ASSOCIATION_MESSAGE = " Item(s) associated with this inventory transaction"
    ...
    /**
     * Delete inventory transaction object(Inventory In From Supplier) frob DB
     * @param params -N/A
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // delete inventory transaction object (Inventory In From Supplier)
