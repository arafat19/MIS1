...
/**
 *  Search specific list of task for process instrument
 *  For details go through Use-Case doc named 'SearchTaskForProcessInstrumentActionService'
 */
class SearchTaskForProcessInstrumentActionService extends BaseService implements ActionIntf {
    ...
    Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map searchResult = rmsTaskService.searchTaskForProcessInstrument(bankId, exhHouseId, currentStatus, taskListId, processTypeId, instrumentTypeId, fromDate, toDate, branchId, this)
    ...
    private List wrapTask(List<RmsTask> lstTask, int start) {
        ...
        for (int i = 0; i < lstTask.size(); i++) {
            ...
            obj.cell = [
                    ...
                    bank.name + Tools.EMPTY_SPACE_COMA + district.name + Tools.EMPTY_SPACE_COMA + bankBranch.name,
