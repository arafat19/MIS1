...
class PtBugService extends BaseService {
    ...
    public List<PtBug> findAllByModuleIdAndSprintIdAndCompanyId(long moduleId, long sprintId, long companyId) {
        List<PtBug> lstBugs = PtBug.findAllByModuleIdAndSprintIdAndCompanyId(moduleId, sprintId, companyId, [readOnly: true])
        return lstBugs
    }
