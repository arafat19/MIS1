...
/**
 * Download  financial statement in PDF or Excel format for level 5
 * Report will contain  coa of all(tier1, tier2, tier3, tier4, tier5(if any))
 * For details go through Use-Case doc named 'DownloadForFinancialStatementOfLevel5ActionService'
 */
class DownloadForFinancialStatementOfLevel5ActionService extends BaseService implements ActionIntf {
    ...
    private static final String REPORT_FOLDER = 'accFinancialStatement' + File.separator + 'level5'
    private static final String OUTPUT_FILE_NAME = 'accFinancialStatementOfLevel5'
    private static final String REPORT_TITLE = 'accFinancialStatementOfLevel5'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String SUBREPORT_DIR = 'SUBREPORT_DIR'
    private static final String REPORT = "report"
    private static final String ACC_BALANCE_SHEET_REPORT = 'accFinancialStatementOfLevel5.jasper'
    ...
    private static final String LST_DIVISION_IDS = "lstDivisionIds"
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getFinancialStatementReport(fromDate, toDate, formatType, postedByParam, lstProjectIds, projectName,
                    divisionId, lstDivisionIds, divisionName)// get financial statement report
     ...
     * @param lstDivisionIds - list of division ids
     * @param divisionName - name of division
     * @return - generated report with required params
     */
    @Transactional(readOnly = true)
    private Map getFinancialStatementReport(Date fromDate, Date toDate, String formatType, long postedByParam, List<Long> projectIdList,
                                            String projectName, long divisionId, List<Long> lstDivisionIds, String divisionName) {
        ...
        reportParams.put(LST_DIVISION_IDS, lstDivisionIds)

        // Now retrieve the sum of debit & sum of credit
        Map incomeStatementSumList = getIncomeStatementSum(fromDate, toDate, projectIdList, postedByParam, divisionId)
        ...
        JasperReportDef reportDef = new JasperReportDef(name: ACC_BALANCE_SHEET_REPORT, fileFormat: jasperExportFormat,
