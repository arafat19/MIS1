...
class GetDropDownRoleTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<Role> lstRole = roleCacheUtility.list()
            String html = buildDropDown(lstRole, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
    ...
    private String buildDropDown(List<Role> lstRole, Map dropDownAttributes) {
        ...
        if (showHints.booleanValue()) {
            lstRole = Tools.listForKendoDropdown(lstRole, null, hintsText)  // the null parameter indicates that dataTextField is name
        }
