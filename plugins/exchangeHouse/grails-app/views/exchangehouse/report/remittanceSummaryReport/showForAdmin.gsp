<div id="application_top_panel" class="panel panel-primary">
    ...
    <form id='cashierWiseReportSummaryForAdmin' name='cashierWiseReportSummaryForAdmin' class="form-horizontal form-widgets" role="form">
        <div class="panel-body">
            <div class="form-group">
                <label class="col-md-2 control-label label-required" for="createdDateFrom">From Date:</label>
                <div class="col-md-2">
                    <app:dateControl name="createdDateFrom">
                    </app:dateControl>
                </div>

                <label class="col-md-2 control-label label-required" for="createdDateTo">To Date:</label>
                <div class="col-md-2">
                    <app:dateControl name="createdDateTo">
                    </app:dateControl>
                </div>
            </div>
        </div>
...
<g:render template='/exchangehouse/report/remittanceSummaryReport/scriptForAdmin'/>