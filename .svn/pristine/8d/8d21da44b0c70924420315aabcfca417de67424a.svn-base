...
/**
 *  Class to get list of accVoucherTypeCoa object(s) to show on grid
 *  For details go through Use-Case doc named 'ListAccVoucherTypeCoaActionService'
 */
class ListAccVoucherTypeCoaActionService extends BaseService implements ActionIntf {

    @Autowired
    AccSessionUtil accSessionUtil

    private static final String DEFAULT_ERROR_MESSAGE = "Failed to get voucher type grid list"
