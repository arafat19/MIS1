...
/**
 *  Search list of user group(appGroup) for grid
 *  For details go through Use-Case doc named 'SearchAppGroupActionService'
 */
class SearchAppGroupActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Failed to load Group List"
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            initSearch(params)
            Map searchResult = appGroupCacheUtility.search(queryType, query, this)
            List<AppGroup> groupList = searchResult.list
