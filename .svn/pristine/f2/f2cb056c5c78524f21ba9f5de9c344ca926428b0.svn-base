...
/**
 * Download Supplier Wise Purchase Order PDF report
 * For details go through Use-Case doc named 'DownloadForSupplierWisePOActionService'
 */
class DownloadForSupplierWisePOActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Fail to download Supplier Wise PO Report."
    ...
    private static final String JASPER_FILE_PDF = 'supplierWisePO.jasper'
