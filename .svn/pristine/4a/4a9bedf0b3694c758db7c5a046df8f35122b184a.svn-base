 ...
 * For details go through Use-Case doc named 'ListForTrialBalanceOfLevel2ActionService'
 */
class ListForTrialBalanceOfLevel2ActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get trial balance level 2 list
     * @param parameters - serialized parameters from UI
     * @param obj -N/A
     * @return - a map containing trial balance level 2 for grid and error msg(True/False)
     */
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            List<GroovyRowResult> returnTrailBalanceList = getTrialBalanceListOfLevel2(fromDate, toDate, lstProjectIds, postedByParam, divisionId)
     ...
     * @return - a map containing wrapped trial balance level 2 for grid and error msg(True/False)
     */
    ...
    /**
     * Wrap trial balance level 2 list for grid
    ...
    private List<GroovyRowResult> getTrialBalanceListOfLevel2(Date fromDate, Date toDate, List<Long> projectIdList,
        ...
        String strQuery = """
            ...
            AND coa.tier1 > 0
            GROUP BY coa.acc_type_id,t1.name
