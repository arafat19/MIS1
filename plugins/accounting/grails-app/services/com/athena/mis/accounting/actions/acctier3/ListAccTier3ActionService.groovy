...
/**
 *  Class to get list of AccTier3 object(s) to show on grid
 *  For details go through Use-Case doc named 'ListAccTier3ActionService'
 */
class ListAccTier3ActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Failed to load Tier-3 list"
