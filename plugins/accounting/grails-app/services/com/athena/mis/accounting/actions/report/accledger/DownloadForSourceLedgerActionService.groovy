...
/*
 * Download source ledger in pdf format
 * For details go through Use-Case doc named 'DownloadForSourceLedgerActionService'
 */
class DownloadForSourceLedgerActionService extends BaseService implements ActionIntf {
    ...
    private static final String ACC_SOURCE_LEDGER = 'accSourceLedger.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            // assign default value -1 for empty string(Kendo dropDown returns for noSelection) that indicates "ALL"
            ...
            Map report = getSourceLedgerReportMap(accSourceTypeId, lstSourceIds, fromDate, toDate, projectIds, sourceName, projectName, postedByParam, sourceCategoryName) // get source ledger PDF report
    ...
    private Map getSourceLedgerReportMap(long accSourceTypeId, List lstSourceIds, Date fromDate, Date toDate, List projectIds, String sourceName, String projectName, long postedByParam, String sourceCategoryName) {
        ...
        List prevLedgerBalanceList = AccVoucherModel.previousBalanceBySourceTypeAndSource(accSourceTypeId, lstSourceIds, fromDate, projectIds, postedByParam, accSessionUtil.appSessionUtil.getAppUser().companyId).list()
