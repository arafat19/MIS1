...
class GetDropDownCompanyTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<Company> lstCompany = companyCacheUtility.list()
            String html = buildDropDown(lstCompany, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
    ...
    private String buildDropDown(List<Company> lstCompany, Map dropDownAttributes) {
        ...
        if (showHints.booleanValue()) {
            lstCompany = Tools.listForKendoDropdown(lstCompany, null, hintsText)  // the null parameter indicates that dataTextField is name
        }
