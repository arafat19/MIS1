...
/*Renders html of 'select' for Fixed asset items objects for consumption*/

class GetDropDownFxdItemForConsumptionTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List lstItem = listOfItemForConsumption()
    ...
    private List<GroovyRowResult> listOfItemForConsumption() {
        List<GroovyRowResult> result = executeSelectSql(SELECT_QUERY)
        return result
    }
