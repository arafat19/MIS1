 ...
 */
class ExhListCustomerActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            if (!params.sortname) {  // if no sort name then sort by name/asc
                params.sortname = SORT_COLUMN_NAME
                params.sortorder = ASCENDING_SORT_ORDER
            }

            initPager(params)         // initialize parameters for flexGrid

            LinkedHashMap serviceReturn = listCustomer()             // get customer(s)
            List<ExhCustomer> lstCustomer = (List<ExhCustomer>) serviceReturn.customerList
    ...
    public LinkedHashMap listCustomer() {
        ...
        List<ExhCustomer> lstCustomer = ExhCustomer.findAllByCompanyId(companyId, [max: resultPerPage, offset: start, sort: sortColumn, order: sortOrder, readOnly: true])
