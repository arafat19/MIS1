...
class ShowDocCategoryForAllUserActionService extends BaseService implements ActionIntf {
    ...
    * get category object by urlInName,companyId
    ...
    * */
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            String urlInName = parameterMap.id.toString()
            DocCategory category = docCategoryCacheUtility.findByUrlInName(urlInName, companyId)
