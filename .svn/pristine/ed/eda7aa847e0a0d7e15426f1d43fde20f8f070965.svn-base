...
/**
 * download  ledger in csv format
 * For details go through Use-Case doc named 'DownloadForLedgerCsvActionService'
 */
class DownloadForLedgerCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String ACC_LEDGER_REPORT = 'accLedgerCsv.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getLedgerReport(accChartOfAccount, fromDate, toDate, projectIds, projectName, postedByParam)  // get group ledger CSV report
    ...
    private Map getLedgerReport(AccChartOfAccount accChartOfAccount, Date fromDate, Date toDate, List projectIds, String projectName, long postedByParam) {
        ...
        String previousLedgerBalanceStr = new DecimalFormat(Tools.AMOUNT_FORMAT_CSV).format(prevLedgerBalance)
        ...
        JasperReportDef reportDef = new JasperReportDef(name: ACC_LEDGER_REPORT, fileFormat: JasperExportFormat.CSV_FORMAT,
