...
<div class="col-md-6">
		...
		<div class="col-md-7">
			<div class="row">
				...
				<div class="col-md-4" style="padding: 0">
					<input type='button' tabindex="24" name="grandTotalLink" id="grandTotalLink"
					       class="k-button"
					       value="Calculate"
	...
	<div id="paidByNoSpan" style="display: none">
		<div class="form-group">
			<label class="col-md-5 control-label label-required" for="paidByNo"
			       id="lblPaidByNo">Transaction No:</label>
