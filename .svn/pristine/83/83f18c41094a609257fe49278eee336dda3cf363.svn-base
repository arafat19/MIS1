...
class ApplyDocMemberJoinRequestActionService extends BaseService implements ActionIntf {
    ...
    * Insert DocMemberJoinRequest object into DB
    * @return - A map containing all objects of entity, categoryLabel for buildSuccessResultForUI
    * Ths method is in Transactional boundary so will rollback in case of any exception
    * */
