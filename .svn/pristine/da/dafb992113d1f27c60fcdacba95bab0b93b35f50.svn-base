<div id="application_top_panel" class="panel panel-primary">
    ...
    <form id="customGroupForm" name="customGroupForm" class="form-horizontal form-widgets" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" class="k-textbox" id="name" name="name"
                           placeholder="Custom Group Name" required validationMessage="Required"/>
                </div>
