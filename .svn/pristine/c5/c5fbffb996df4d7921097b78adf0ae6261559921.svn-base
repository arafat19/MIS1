...
/**
 *  download task report for issue PO
 *  For details go through Use-Case doc named 'DownloadTaskReportForIssuePoActionService'
 */
class DownloadTaskReportForIssuePoActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'issuePo'
    private static final String CSV_EXTENSION = ".csv"

    private static final String REPORT_FILE_FORMAT = 'csv'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'issuePoCsv.jasper'
     ...
     */
    private Map getTaskReport(long exhHouseId, String exchangeHouseName,String taskListName, long taskListId, long currentStatus, long processTypeId, long instrumentTypeId, Timestamp fromDate, Timestamp toDate, String companyCode,taskStatus) {
