...
/**
 * Show list of agent commission for Agent.
 * For details go through Use-Case doc named 'ListAgentWiseCommissionForAgentActionService'
 */
class ListAgentWiseCommissionForAgentActionService extends BaseService implements ActionIntf {
    private Logger log = Logger.getLogger(getClass())

    private static final String DEFAULT_ERROR_MSG = "Failed to load agent commission report"
    ...
    /**
     * Get list of commission for grid
     * @param parameters -serialized parameters from UI
     * @param obj -N/A
    ...
    /**
     * Wrap list of tasks commission in grid entity
     * @param lstSummary
    ...
    public Object buildFailureResultForUI(Object obj) {
        ...
        try {
            result.put(Tools.IS_ERROR, Boolean.TRUE)
            if (obj) {
                Map preResult = (Map) obj              // cast map returned from execute method
