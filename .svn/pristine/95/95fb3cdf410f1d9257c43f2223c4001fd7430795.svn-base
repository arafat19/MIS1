...
<div id="application_top_panel" class="panel panel-primary">
    ...
    <form id='filterPanelIssuePoForm' name='filterPanelIssuePoForm' class="form-horizontal form-widgets" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    ...
                    <app:systemEntityByReserved name="hidInstrumentType"
                                                reservedId="${RmsInstrumentTypeCacheUtility.PO}"
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <rms:dropDownExchangeHouseFiltered task_status_list="${RmsTaskStatusCacheUtility.DECISION_APPROVED}"
                                                       ...
                                                       instrument="${RmsInstrumentTypeCacheUtility.PO}"
