...
/*Renders html of 'select' for AppUser objects by SubCategoryId*/

class GetDropDownAppUserDocSubCategoryTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            if ((!id) || (!name) || (!dataModelName) || (!strSubCategoryId) || (strSubCategoryId.length() == 0) || (!url) || (url.length() == 0)) {
                return dropDownAttributes
            }
            long subCategoryId = Long.parseLong(strSubCategoryId)
            dropDownAttributes.put(SUB_CATEGORY_ID, new Long(subCategoryId))         // set the subCategoryId
    ...
    /** Get the list of AppUser objects by subCategoryId
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            Long subCategoryId = (Long) dropDownAttributes.get(SUB_CATEGORY_ID)
            List<GroovyRowResult> lstAppUser = (List<GroovyRowResult>) listAppUser(subCategoryId)
    ...
    /**
     * get list of User by subCategoryId
     * @param subCategoryId - SubCategory Id
     * @return lstAppUser - List of User
     */
    private List<GroovyRowResult> listAppUser(long subCategoryId) {
        ...
        String queryForList = """
            ...
            AND id NOT IN
                (
                    SELECT user_id
                    FROM doc_sub_category_user_mapping
    ...
    private String buildDropDown(List<GroovyRowResult> lstAppUser, Map dropDownAttributes) {
        ...
        attributes.each {                          //set dropdown attributes to strAttributes
            if (it.value) {
