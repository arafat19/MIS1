...
/**
 *  Search Indent Details and show related list of indent details for grid
 *  For details go through Use-Case doc named 'SearchIndentDetailsActionService'
 */
class SearchIndentDetailsActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            List<ProcIndentDetails> indentDetailsList = ProcIndentDetails.searchByIndentId(indentId, queryType, query).list(offset: start, max: resultPerPage, sort: sortColumn, order: sortOrder, readOnly: true)
            int total = ProcIndentDetails.searchByIndentId(indentId, queryType, query).count()
