...
class ExhSearchSanctionForCustomerActionService extends BaseService implements ActionIntf {
    ...
    Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            if (params.customerName) {
                ...
                serviceReturn = searchFromCustomerView(customerName)
            } else {
    ...
    private LinkedHashMap searchFromCustomerView(String customerName) {
