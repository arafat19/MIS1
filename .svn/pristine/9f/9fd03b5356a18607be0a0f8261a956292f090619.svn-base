...
/**
 * Download CSV of Current Fixed Asset.
 * For details go through Use-Case doc named 'DownloadForCurrentFixedAssetCsvActionService'
 */
class DownloadForCurrentFixedAssetCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Failed to Download Current fixed asset Csv report"
    ...
    private static final String REPORT_TITLE = 'Current fixed asset Csv Report'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'currentFixedAssetCsv.jasper'
    ...
    /**
     * 1. get list of all fixed asset item
