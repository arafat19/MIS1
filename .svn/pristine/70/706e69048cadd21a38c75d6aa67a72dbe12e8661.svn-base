...
/**
 *  Search pay cash voucher and show specific list of pay cash voucher
 *  For details go through Use-Case doc named 'SearchAccVoucherPayCashActionService'
 */
class SearchAccVoucherPayCashActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get pay cash voucher list for grid through specific search
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // assign query object based on query type
            def queryObject
            ...
            int total = (int) AccVoucher.searchByVoucherType(voucherTypeObj.id, queryType, queryObject, companyId).count()
