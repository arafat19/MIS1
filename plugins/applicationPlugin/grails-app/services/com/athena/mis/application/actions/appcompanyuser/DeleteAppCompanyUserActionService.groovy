...
/**
 *  Delete company user(appUser) object from DB and cache utility and remove it from grid
 *  For details go through Use-Case doc named 'DeleteAppCompanyUserActionService'
 */
class DeleteAppCompanyUserActionService extends BaseService implements ActionIntf {

    private static final String DELETE_USER_SUCCESS_MESSAGE = "Company user has been deleted successfully"
    private static final String DELETE_USER_FAILURE_MESSAGE = "Company user could not be deleted, Please refresh the user List"
    ...
    /**
     * Check if user has access to delete company user or not
     * Get company user(appUser) object from cache utility by appUserId
     *      1. check if company user(appUser) exists or not
     *      2. check association of company user(appUser) with relevant domains
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            // only development role type user can delete company user
    ...
    /**
     * Delete company user(appUser) object from DB and cache utility
     * This method is in transactional block and will roll back in case of any exception
     * Delete all images(e.g : Photo, signature, logo etc) of company user(appUser)
     * @param parameters -parameters from UI
     * @param obj -N/A
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            AppUser appUser = (AppUser) appUserCacheUtility.read(appUserId)
            boolean deleteSuccess = appUserService.delete(appUser)  // delete company user(appUser) object from DB
            appUserCacheUtility.delete(appUser.id) // delete company user(appUser) object from cache utility
