...
/**
 *  Show list of unapproved task for grid for Customer
 *  For details go through Use-Case doc named 'ExhListUnApprovedTaskForCustomerActionService'
 */
class ExhListUnApprovedTaskForCustomerActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            LinkedHashMap serviceReturn = listUnApprovedTask()                  // get list of un-approved task
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List<ExhTask> tasks = wrapTasksForCustomer(taskList, start)
    ...
    /**
     * Get list & count of task which status is UN-APPROVED
     */
    private LinkedHashMap listUnApprovedTask() {
        ...
        long statusUnApprove = exhStatusUnApprovedSysEntityObject.id
        List<ExhTask> taskList = ExhTask.findAllByCompanyIdAndCustomerIdAndCurrentStatus(
                companyId, customerId, statusUnApprove,
