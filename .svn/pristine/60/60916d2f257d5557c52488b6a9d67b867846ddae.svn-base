...
<div id="application_top_panel" class="panel panel-primary">
    <div class="panel-heading">
        <div class="panel-title">
            Search Inventory Status With Quantity
        </div>
    </div>

    <form id="quantitySearchForm" name="quantitySearchForm" class="form-horizontal form-widgets" role="form">
        ...
        <div class="panel-footer">
            ...
            <app:ifAnyUrl
                    urls="/invReport/downloadInventoryStatusWithQuantity,/invReport/downloadInventoryStatusWithQuantityCsv">
                <span class="download_icon_set">
                    <ul>
                        <li>Save as :</li>
                        <app:ifAllUrl urls="/invReport/downloadInventoryStatusWithQuantity">
                            <li><a href="javascript:void(0)" id="printPdfBtn" class="pdf_icon"></a></li>
                        </app:ifAllUrl>
                        <app:ifAllUrl urls="/invReport/downloadInventoryStatusWithQuantityCsv">
