...
class SearchForCancelledPoActionService extends BaseService implements ActionIntf {
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            ProcCancelledPO procCancelledPO = ProcCancelledPO.findByIdAndCompanyId(purchaseOrderId, procSessionUtil.appSessionUtil.getCompanyId(), [readOnly: true])
            ...
            boolean isAccessible = projectCacheUtility.isAccessible(procCancelledPO.projectId)
            if (!isAccessible) {
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            ProcCancelledPO purchaseOrder = (ProcCancelledPO) preResult.get(PURCHASE_ORDER_OBJ)
            ...
            LinkedHashMap purchaseOrderMap = buildCancelledPurchaseOrderMap(purchaseOrder)

            result.put(IS_APPROVED, Boolean.TRUE)    // all cancelled PO is applicable to download
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            result.put(CANCELLED_FLAG, Tools.TRUE)
     ...
     */
    private LinkedHashMap buildCancelledPurchaseOrderMap(ProcCancelledPO purchaseOrder) {
        Project project = (Project) projectCacheUtility.read(purchaseOrder.projectId)
        AppUser cancelledBy = (AppUser) (purchaseOrder.cancelledBy > 0 ? appUserCacheUtility.read(purchaseOrder.cancelledBy) : appUserCacheUtility.read(purchaseOrder.cancelledBy))
    ...
    private List<GroovyRowResult> listItemByPurchaseOrderId(long purchaseOrderId) {
        ...
        FROM proc_cancelledpodetails purchase_order_details
