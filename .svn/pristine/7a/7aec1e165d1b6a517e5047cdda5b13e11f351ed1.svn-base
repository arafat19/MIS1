...
/**
 *  Show list of unapproved inventory transaction(Inventory In From Supplier) for dashBoard
 *  For details go through Use-Case doc named 'ListUnApprovedInFromSupplierActionService'
 */
class ListUnApprovedInFromSupplierActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Failed to populate un-approved supplier list"
    ...
    /**
     * Get unapproved inventory transaction list (Inventory In From Supplier) for dashBoard
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // get list and count of unapproved inventory transaction (Inventory In From Supplier)
            if (inventoryIds.size() > 0) {
                serviceReturn = listUnApprovedInFromSupplier(inventoryIds)
    ...
    /**
     * Wrap unapproved inventory transaction list (Inventory In From Supplier) for dashBoard
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List lstWrappedInventoryIn = wrapUnapprovedInventoryInList(lstUnApprovedInventoryIn, start)
    ...
    /**
     * Wrap unapproved list of inventory transactions (Inventory In From Supplier) in grid entity
     * @param unApprovedList -list of unapproved inventory transaction object(s)
     * @param start -starting index of the page
     * @return -list of wrapped unapproved inventory transactions (Inventory In From Supplier)
     */
    private List wrapUnapprovedInventoryInList(List<GroovyRowResult> unApprovedList, int start) {
    ...
    /**
     * Get list and count of unapproved inventory transactions (Inventory In From Supplier)
     * @param lstInventoryIds -list of inventory ids
     * @return -a map containing list and count of unapproved inventory transactions (Inventory In From Supplier)
     */
    private LinkedHashMap listUnApprovedInFromSupplier(List<Long> lstInventoryIds) {
