...
class DeleteDocArticleActionService extends BaseService implements ActionIntf {

    private Logger log = Logger.getLogger(getClass());

    private static final String DELETE_SUCCESS_MSG = "Article has been successfully deleted!"
    private static final String DEFAULT_ERROR_MESSAGE = "Failed to delete article."
    ...
    * */
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            DocArticle article = (DocArticle) docArticleService.read(id)
            if (!article) {
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            docArticleService.delete(article.id)
            result.put(DOC_ARTICLE, article)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            return result
        } catch (Exception e) {
