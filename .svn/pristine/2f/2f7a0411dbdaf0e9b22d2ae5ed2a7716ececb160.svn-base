...
/**
 * Download received items of PO report in csv format
 * For details go through Use-Case doc named 'InvDownloadForPoItemReceivedCsvActionService'
 */
class InvDownloadForPoItemReceivedCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String JASPER_FILE = 'poItemReceivedCsv.jasper'
    private static final String PO_NOT_FOUND = "PO not found"
    private static final String FAILURE_MSG = "Fail to download PO item received csv report"
