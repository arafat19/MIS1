...
/**
 * Download CSV report of Combined QS Measurement
 * For details go through Use-Case doc named 'DownloadForCombinedQSMCsvActionService'
 */
class DownloadForCombinedQSMCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Fail to download combined Qs Measurement CSV Report."
    ...
    private static final String REPORT_TITLE = 'Combined Qs Measurement CSV Report'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'combinedQSMCsv.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getCombinedQsMCsvReport(projectId, fromDate, toDate, projectName)
    ...
    /**
     * Generate CSV report using given data
     ...
     */
    private Map getCombinedQsMCsvReport(long projectId, Date fromDate, Date toDate, String projectName) {
