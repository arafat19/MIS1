...
/**
 *  List of Item-Stock for grid
 *  For details go through Use-Case doc named 'ListForItemStockActionService'
 */
class ListForItemStockActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            LinkedHashMap serviceReturn = getItemStockList()
    ...
    private static final String COUNT_QUERY = """
        ...
        """
    /**
     * get itemStockList of all inventory of which ItemCategory is Inventory OR FixedAsset
