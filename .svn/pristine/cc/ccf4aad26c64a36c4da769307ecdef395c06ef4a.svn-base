...
/**
 *  Show received bank(cheque) voucher in the grid
 *  For details go through Use-Case doc named 'ShowAccVoucherReceiveBankActionService'
 */
class ShowAccVoucherReceiveBankActionService extends BaseService implements ActionIntf {
    ...
    private static final String LST_DEBIT_COA_VOUCHER_TYPE = "lstDebitCoaVoucherType"
    ...
    /**
     * Get receive bank voucher list for grid
    ...
    /**
     * Wrap received bank(cheque) voucher list for grid
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            long companyId = accSessionUtil.appSessionUtil.getCompanyId()
            SystemEntity accVoucherTypeReceiveBank = (SystemEntity) accVoucherTypeCacheUtility.readByReservedAndCompany(accVoucherTypeCacheUtility.RECEIVED_VOUCHER_BANK_ID, companyId)
            List lstCoaVoucherType = accVoucherTypeCoaCacheUtility.listCoa(accVoucherTypeReceiveBank)
    ...
    /**
     * Wrap list of receive bank(cheque) voucher in grid entity
     * @param voucherList -list of receive bank(cheque) voucher object(s)
     * @param start -starting index of the page
     * @return -list of wrapped receive bank(cheque) voucher
     */
