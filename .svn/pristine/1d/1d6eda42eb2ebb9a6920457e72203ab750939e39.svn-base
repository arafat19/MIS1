...
/**
 *  Show UI for theme CRUD and list of theme for grid
 *  For details go through Use-Case doc named 'ShowThemeActionService'
 */
class ShowThemeActionService extends BaseService implements ActionIntf {
    ...
    private static final String SHOW_FAILURE_MESSAGE = "Failed to load theme configuration page"
    private static final String NOT_DEVELOPMENT_USER = "You are not allowed to show theme page"
