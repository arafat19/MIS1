...
class ListRefundTaskForSendToSarbActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get parameters from UI and list,count all refund task from db
     * @param parameters
     * @param obj -N/A
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            List<Long> lstStatusForSendTask = []
            lstStatusForSendTask << exchangeHouseImplService.readExhTaskStatusRefund(companyId).id.longValue() //exh system entity id of refund task
