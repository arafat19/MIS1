...
class ListReplaceTaskForSendToSarbActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get parameters from UI and list,count all replace task from db
     * @param parameters
     * @param obj -N/A
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            SystemEntity reviseStatus = (SystemEntity) sarbTaskReviseStatusCacheUtility.readByReservedAndCompany(SarbTaskReviseStatusCacheUtility.MOVED_FOR_REPLACE, companyId)
