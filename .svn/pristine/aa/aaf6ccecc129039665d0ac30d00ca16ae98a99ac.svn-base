...
/**
 *  Download Inventory Status report in CSV format
 *  For details go through Use-Case doc named 'DownloadForInventoryStatusWithQuantityAndValueCsvActionService'
 */
class DownloadForInventoryStatusWithQuantityAndValueCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String INVALID_INPUT = "Project not found"
    ...
    private static final String FAILURE_MSG = "Failed to generate inventory status report"
    private static final String REPORT_FOLDER = 'inventoryStatus'
    private static final String REPORT = "report"
    private static final String OUTPUT_FILE_NAME = 'inventoryStatus'
    ...
    private static final String REPORT_TITLE = 'Inventory Status'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'inventoryStatusCsv.jasper'
