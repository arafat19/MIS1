...
/**
 *  Show list of un-approved receive bank(cheque) for grid
 *  For details go through Use-Case doc named 'ListUnApprovedReceiveBankActionService'
 */
class ListUnApprovedReceiveBankActionService extends BaseService implements ActionIntf {
    ...
    private static final String SERVER_ERROR_MESSAGE = "Fail to get un-posted receive bank list"
    ...
    /**
     * Get list of un-approved receive bank(cheque) for grid
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // Get un-approved receive bank(cheque) using dynamic finder
    ...
    /**
     * Wrap un-approved receive bank(cheque) list for grid
    ...
    /**
     * Wrap list of un-approved receive bank(cheque) in grid entity
     * @param voucherList -list of un-approved receive cash object(s)
     * @param start -starting index of the page
     * @return -list of wrapped un-approved receive bank(cheque)
     */
