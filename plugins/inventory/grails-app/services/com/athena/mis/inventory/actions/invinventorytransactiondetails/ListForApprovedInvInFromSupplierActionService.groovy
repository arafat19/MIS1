...
/**
 *  Show approved list of inventory transaction details(Inventory In From Supplier) for grid
 *  For details go through Use-Case doc named 'ListForApprovedInvInFromSupplierActionService'
 */
class ListForApprovedInvInFromSupplierActionService extends BaseService implements ActionIntf {
