 ...
 */
class UpdateAppCompanyUserActionService extends BaseService implements ActionIntf {
    ...
    private static final String APP_USER_UPDATE_FAILURE_MESSAGE = "Company user could not be updated"
     ...
     *      1. check if user has access to update company user or not
    ...
    public Object executePreCondition(Object params, Object obj) {
        ...
        try {
            ...
            // only development role type user can update company user
    ...
    /**
     * Update company user(appUser) object in DB & update cache utility accordingly
     * If signature image is updated then
    ...
    /**
     * Show updated company user(appUser) object in grid
