...
/**
 *  Show UI for financial statement and list of financial statement for grid
 *  For details go through Use-Case doc named 'ShowForFinancialStatementActionService'
 */
class ShowForFinancialStatementActionService extends BaseService implements ActionIntf {

    private Logger log = Logger.getLogger(getClass())

    private static final String FAILURE_MSG = "Fail to load financial statement"
