...
class MoveSarbTaskForReplaceActionService extends BaseService implements ActionIntf {
    ...
    private static final String NOT_CANCELLED = "Only cancelled task can be moved to replace"
    private static final String TASK_MODEL = "sarbTaskModel"
    private static final String TASK_RESEND_SUCCESS = "Task has been moved to replace"
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            if(!taskModel.isCancelled) {
                result.put(Tools.MESSAGE, NOT_CANCELLED)
                return result
            }
    ...
    /**
     * update sarbTask for move for replace
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            sarbTaskDetailsService.updateForMove(sarbTaskDetails, movedForReplace.id)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
