...
/**
 * Download source wise balance in csv format
 * For details go through Use-Case doc named 'DownloadForSourceWiseBalanceCsvActionService'
 */
class DownloadForSourceWiseBalanceCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String FAILURE_MSG = "Failed to generate source wise balance csv report"
    ...
    private static final String JASPER_FILE_WITHOUT_COA = 'sourceWiseBalanceCSV.jasper'
    private static final String JASPER_FILE_WITH_COA = 'sourceWiseBalanceByCoaIdCSV.jasper'
    ...
    private Map getSourceWiseBalanceReport(long sourceTypeId, long coaId, Date toDate, Date fromDate, long postedByParam, List<Long> projectIds, String projectName, List<Long> lstSourceCategoryIds) {
        ...
        if (coaId > 0) {
            ...
            String coaDescription = chartOfAccount.description + Tools.PARENTHESIS_START + chartOfAccount.code + Tools.PARENTHESIS_END  // coa description with code
