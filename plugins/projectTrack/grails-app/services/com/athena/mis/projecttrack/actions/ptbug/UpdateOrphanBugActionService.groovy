...
/**
 *  Update orphan bug object, entity content for bug and show updated object on grid
 *  For details go through Use-Case doc named 'UpdateOrphanBugActionService'
 */
class UpdateOrphanBugActionService extends BaseService implements ActionIntf {
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            AppUser appUser = (AppUser) appUserCacheUtility.read(bug.createdBy)
