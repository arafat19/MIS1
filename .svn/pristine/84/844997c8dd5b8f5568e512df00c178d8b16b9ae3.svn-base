...
class DeleteItemCategoryNonInvActionService extends BaseService implements ActionIntf {
    ...
    private static final String ITEM_DELETE_FAILURE_MSG = "Sorry! Item has not been deleted"
