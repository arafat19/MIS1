<script type="text/javascript">
    ...
    var taskListModel = false, taskId;
    ...
    function executePostConditionForRefundTask(data) {
    ...
    function initFlexGrid() {
        ...
        (
                {
                    url: "${createLink(controller: 'sarbTaskModel', action: 'listRefundTaskForShowStatus')}?taskId="+taskId,
                    dataType: 'json',
                    colModel: [
