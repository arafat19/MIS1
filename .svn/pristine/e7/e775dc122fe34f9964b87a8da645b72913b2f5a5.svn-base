...
class GetDropDownDesignationTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<Designation> lstDesignation = designationCacheUtility.list()
            String html = buildDropDown(lstDesignation, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
     ...
     * @return - html string for select
     */
    private String buildDropDown(List<Designation> lstDesignation, Map dropDownAttributes) {
        // read map values
        ...
        if (showHints.booleanValue()) {
            lstDesignation = Tools.listForKendoDropdown(lstDesignation, null, hintsText)  // the null parameter indicates that dataTextField is name
        }
