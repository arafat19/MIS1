...
class ApprovedDocMemberJoinRequestActionService extends BaseService implements ActionIntf {
    ...
    private static final String OBJECT_NOT_FOUND_MESSAGE = ' not found'
     ...
     * 4. check DocMemberJoinRequest existence
     * 5. check category existence
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            if (!category) {
                result.put(Tools.MESSAGE, categoryLabel + OBJECT_NOT_FOUND_MESSAGE)
                return result
            }
            ...
            if (joinRequest.subCategoryId > 0) {
                ...
                if (!subCategory) {
                    result.put(Tools.MESSAGE, subCategoryLabel + OBJECT_NOT_FOUND_MESSAGE)
                    return result
                }

                subCategoryId = joinRequest.subCategoryId
    ...
    *   3. check sub category if exists send mail to user with sub category
    *   4.send mail to user with success message for be a member in this category or sub category
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            if (subCategory) {
                ...
                mailParams = [subCategoryLabel: subCategoryLabel, subCategoryName: subCategory.name, subCategoryDescription: subCategory.description ? subCategory.description : Tools.EMPTY_SPACE,
                        categoryLabel: categoryLabel, categoryName: category.name, categoryDescription: category.description ? category.description : Tools.EMPTY_SPACE,
                ...
                mailParams = [categoryLabel: categoryLabel, categoryName: category.name, categoryDescription: category.description ? category.description : Tools.EMPTY_SPACE,
                        loginId: joinRequest.email, loginUrl: loginUrl, password: password]
    ...
    * */
    ...
    /*
    * Create User,UserRole and mapping with category/sub-category
    * update join request and Create appUser into appUserCacheUtility
    ...
    * @param joinRequest - DocMemberJoinRequest object
    * @param password
    * @return newAppUser - new AppUser object
    * */
