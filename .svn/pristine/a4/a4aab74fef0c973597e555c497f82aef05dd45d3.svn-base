...
/**
 *  Child class to show UI of unapproved inventory item(s) for consumption
 *  For details go through Use-Case doc named 'ShowForUnApprovedInventoryConsumptionDetailsActionService'
 */
class ShowForUnApprovedInventoryConsumptionDetailsActionService extends BaseService implements ActionIntf {
    ...
    /**
     * method to get unapprovedConsumptionList and wrap list for grid
     *
     * @param parameters -serialized parameter sent from UI
     * @param obj -receives from executePreCondition
     *
     * @return -a map containing all objects necessary for show page (WrappedUnapprovedConsumptionList)
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            LinkedHashMap serviceReturn = (LinkedHashMap) listForUnapprovedInvConsumptionDetailsByInvTransId(invInventoryTransaction.id)
            ...
            result.put(INV_TRANS_ID, preResult.get(INV_TRANS_ID))
    ...
    /**
     * Wrap list of unapprovedConsumptionDetailsList for gird
     *
     * @param invInventoryTransactionDetailsList -list of unapprovedConsumptionDetails object(s)
     * @param start -starting index of the page
     *
     * @return -list of wrappedUnapprovedConsumptionDetails
     */
     ...
     * @return -a map containing all objects necessary for show page (wrappedUnapprovedConsumptionDetails)
     * map -contains isError(true/false) depending on method success
     */
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            result.put(INV_TRANS_ID, receiveResult.get(INV_TRANS_ID))
            return result
        } catch (Exception ex) {
