...
/*
 * Download all expenses of specific project in pdf format
 * For details go through Use-Case doc named 'DownloadForProjectWiseExpenseActionService'
 */

class DownloadForProjectWiseExpenseActionService extends BaseService implements ActionIntf {
     ...
     * @param obj - N/A
     * @return - a map containing chart of account object and isError msg(True/False)
     */
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            String formatType = parameterMap.formatType      // set report format type(pdf/csv)
            ...
            Map report = getProjectWiseExpenseReport(groupIds, projectIds, formatType, accChartOfAccount, fromDate, toDate, postedByParam)
     ...
     */
    private Map getProjectWiseExpenseReport(List accGroupIds, List<Long> projectIds, String formatType, AccChartOfAccount coa, Date fromDate, Date toDate, long postedByParam) {
        List coaIds = []
        if (coa) {
