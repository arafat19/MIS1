 ...
 * For details go through Use-Case doc named 'DownloadForInventoryStockCsvActionService'
 */
class DownloadForInventoryStockCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String JASPER_FILE = 'stockCsv.jasper'
    ...
    /**
     * Generate inventory stock report in csv format
