...
/**
 *  Show approved list of inventory transaction details(Inventory In From Inventory) for grid
 *  For details go through Use-Case doc named 'ListForApprovedInvInFromInventoryActionService'
 */
class ListForApprovedInvInFromInventoryActionService extends BaseService implements ActionIntf {
