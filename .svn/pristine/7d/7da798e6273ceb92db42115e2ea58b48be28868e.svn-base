...
class SearchBackLogForSprintActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get ptBacklog list for grid through specific search
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List backLog = wrapBackLog(backLogList, start)                    // warp PtBacklog list for grid
            Map gridOutput = [page: pageNumber, total: count, rows: backLog]
            return gridOutput
        }
        catch (Exception ex) {
            log.error(ex.getMessage())
    ...
    /**
     * Wrap list of ptBacklog for a sprint in grid entity
