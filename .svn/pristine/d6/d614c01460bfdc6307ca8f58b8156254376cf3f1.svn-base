    ...
    <form name='frmVoucher' id='frmVoucher' class="form-horizontal form-widgets" role="form">
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <label class="col-md-2 control-label label-required">Cheque Info:</label>

                <div class="col-md-4">
                    <input type="text" class="k-textbox" id="chequeNo" name="chequeNo" maxlength="30"
                           placeholder="Cheque No." tabindex="1"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <label class="col-md-2 control-label label-required">Cheque Date:</label>
