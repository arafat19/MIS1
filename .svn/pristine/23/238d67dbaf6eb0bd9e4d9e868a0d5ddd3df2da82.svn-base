 ...
 */
class CreateItemCategoryInventoryActionService extends BaseService implements ActionIntf {
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            Item item = buildItemObject(params)
     ...
     * @return -item object
     */
    private Item buildItemObject(GrailsParameterMap params) {
        Item item = new Item(params)
        item.isIndividualEntity = false
        item.companyId = appSessionUtil.getCompanyId()
        SystemEntity inventorySysEntityObject = (SystemEntity) itemCategoryCacheUtility.readByReservedAndCompany(itemCategoryCacheUtility.INVENTORY, item.companyId)
