...
/**
 *  Search receive bank voucher and show specific list of receive cash voucher
 *  For details go through Use-Case doc named 'SearchAccVoucherReceiveBankActionService'
 */
class SearchAccVoucherReceiveBankActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get receive bank voucher list for grid through specific search
    ...
    /**
     * Wrap receive bank voucher  list for grid
    ...
    /**
     * Wrap list of receive bank voucher in grid entity
     * @param voucherList -list of receive bank voucher object(s)
     * @param start -starting index of the page
     * @return -list of wrapped receive bank voucher
     */
