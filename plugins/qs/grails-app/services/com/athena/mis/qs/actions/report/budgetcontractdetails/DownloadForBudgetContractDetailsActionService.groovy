...
/**
 * Download PDF report of Budget Contract Details
 * For details go through Use-Case doc named 'DownloadForBudgetContractDetailsActionService'
 */
class DownloadForBudgetContractDetailsActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'budgetContractDetails'
    private static final String REPORT_TITLE = 'Budget Contract Details Report'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'budgetContractDetails.jasper'
     ...
     * 2. Get map of report by getBudgetContractDetailsReport method
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getBudgetContractDetailsReport(projectId, fromDate, toDate, projectName)
    ...
    /**
     * Generate Budget Contract Details PDF report
     ...
     */
    private Map getBudgetContractDetailsReport(long projectId, Date fromDate, Date toDate, String projectName) {
