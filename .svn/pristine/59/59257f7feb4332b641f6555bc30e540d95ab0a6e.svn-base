...
/**
 *  Show list of acc voucher pay cash for grid
 *  For details go through Use-Case doc named 'ListAccVoucherPayCashActionService'
 */
class ListAccVoucherPayCashActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get acc voucher list of pay cash for grid
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            SystemEntity voucherTypeObj = (SystemEntity) accVoucherTypeCacheUtility.readByReservedAndCompany(accVoucherTypeCacheUtility.PAYMENT_VOUCHER_CASH_ID, companyId)

            // Get voucher list of pay cash by using dynamic finder
    ...
    /**
     * Wrap acc voucher list of pay cash for grid
    ...
    /**
     * Wrap list of acc voucher for pay cash in grid entity
     * @param voucherList -list of acc voucher for pay cash object(s)
     * @param start -starting index of the page
     * @return -list of wrapped accVouchers pay cash
     */
