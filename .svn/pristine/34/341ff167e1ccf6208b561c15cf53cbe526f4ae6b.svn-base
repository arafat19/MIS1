...
import com.athena.mis.inventory.actions.taglib.GetDropDownInventoryOutItemTagLibActionService
import com.athena.mis.utility.Tools

class InvInventoryOutItemDropDownTagLib {
    static namespace = "inv"

    GetDropDownInventoryOutItemTagLibActionService getDropDownInventoryOutItemTagLibActionService

    /**
     * Render html select of inventory item for the given transaction id
     * example:  <inv:dropDownInventoryItemOut transactionId="${transactionId}"></inv:dropDownInventoryItemOut>
     *
     ...
     */
    def dropDownInventoryItemOut = { attrs, body ->
        Map preResult = (Map) getDropDownInventoryOutItemTagLibActionService.executePreCondition(attrs, null)
        Boolean isError = preResult.isError
        if (isError.booleanValue()) {
            out << Tools.EMPTY_SPACE
            return
        }
        String html = getDropDownInventoryOutItemTagLibActionService.execute(preResult, null)
        out << html
    }
