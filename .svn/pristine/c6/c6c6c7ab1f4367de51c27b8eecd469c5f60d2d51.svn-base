...
class ExhSearchSanctionActionService extends BaseService implements ActionIntf {

    private final Logger log = Logger.getLogger(getClass())
    private static final String EXCEPTION_MESSAGE = "Failed to search sanction list"
    private static final String SERVICE_RETURN_OBJ = "serviceReturn"
    private static final String DEFAULT_ERROR_MESSAGE = "Can not search sanction list"
    ...
    Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            if (params.fName) {
                ...
                serviceReturn = searchFromBeneficiaryView(beneficiary)
            } else {
                serviceReturn = search()
            }
    ...
    // Search Sanction for admin
    private LinkedHashMap searchFromBeneficiaryView(ExhBeneficiary beneficiary) {
        ...
        String query = Tools.PERCENTAGE + query + Tools.PERCENTAGE
