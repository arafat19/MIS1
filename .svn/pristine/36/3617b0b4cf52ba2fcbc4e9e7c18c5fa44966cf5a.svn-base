...
/**
 *  Update entityNote object and grid data
 *  For details go through Use-Case doc named 'UpdateExhCustomerNoteActionService'
 */
class UpdateExhCustomerNoteActionService extends BaseService implements ActionIntf {
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            EntityNote entityNote = entityNoteService.read(id)   // get note object
    ...
    /**
     * Show updated note object in grid
    ...
    """
    /**
     * Update note object in DB
     * @param entityNote -EntityNote object
     * @return -updated entityNote object
     */
