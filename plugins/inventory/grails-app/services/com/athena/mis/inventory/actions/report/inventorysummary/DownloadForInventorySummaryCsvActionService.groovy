 ...
 * For details go through Use-Case doc named 'DownloadForInventorySummaryCsvActionService'
 */
class DownloadForInventorySummaryCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String FAILURE_MSG = "Fail to generate inventory summary csv report"
    ...
    private static final String JASPER_FILE = 'inventorySummaryCsv.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getInventorySummaryReport(preResult)   // generate report
            result.put(Tools.IS_ERROR, Boolean.FALSE)
    ...
    /**
     * Generate inventory summary report in csv format
     * @param preResult -map from executePreCondition method
     * @return -generated report
     */
    private Map getInventorySummaryReport(Map preResult) {
