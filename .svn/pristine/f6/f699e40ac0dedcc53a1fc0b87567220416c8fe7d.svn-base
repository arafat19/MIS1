...
/**
 *  Class to get search result list of itemObject (Category : Inventory) to show on grid
 *  For details go through Use-Case doc named 'SearchItemCategoryInventoryActionService'
 */
class SearchItemCategoryInventoryActionService extends BaseService implements ActionIntf {
    ...
    private static final String PAGE_LOAD_ERROR_MESSAGE = "Could not search item list"
    ...
    public Object execute(Object params, Object obj = null) {
        try {
            initSearch(params)
            Map searchResult = itemCacheUtility.searchCategoryWiseItemList(queryType, query, itemCategoryCacheUtility.INVENTORY, this)
