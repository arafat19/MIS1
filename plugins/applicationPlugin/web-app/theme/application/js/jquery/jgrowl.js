...
(function($) {
	...
	$.extend( $.fn.jGrowl.prototype , {
		...
		render:function( notification ) {
			...
			if(iconType=='success'){
			notification = $(
				'<div style="padding-left:40px;" class="jGrowl-notification ui-state-highlight ui-corner-all' +
				((o.group != undefined && o.group != '') ? ' ' + o.group : '') + '">' +
                '<i class="icon_st success_icon"></i>'+        
