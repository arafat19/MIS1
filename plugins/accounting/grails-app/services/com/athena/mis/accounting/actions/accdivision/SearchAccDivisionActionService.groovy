...
/**
 *  Class to get search result list of accDivision object(s) to show on grid
 *  For details go through Use-Case doc named 'SearchAccDivisionActionService'
 */
class SearchAccDivisionActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Failed to search account division list"
    private static final String ACC_DIVISION_LIST = "accDivisionList"
    private static final String COUNT = "count"
    private static final String PROJECT_NAME = "projectName"
    private static final String DIVISION_NAME = "name"
    ...
    /**
     * get search result list of accDivision object(s)
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            initSearch(params)
            List<AccDivision> accDivisionList = []
            int count = 0
            if (queryType.equals(PROJECT_NAME)) {
                Map searchResult = accDivisionCacheUtility.searchByProject(query, this)
                accDivisionList = searchResult.list
                count = searchResult.count
            } else if (queryType.equals(DIVISION_NAME)) {
                Map searchResult = accDivisionCacheUtility.search(queryType, query, this)
                accDivisionList = searchResult.list
                count = searchResult.count
            }
