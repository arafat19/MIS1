			...
			<div class="tab-content">
				<div class="tab-pane active" id="fragmentBasicInfo">
					<div class="panel-body">
						<form name="basicInfoForm" id="basicInfoForm" class="form-horizontal form-widgets" role="form">
				...
				<div class="tab-pane" id="fragmentDisbursementInfo">
					<div class="panel-body">
						<form name="disbursementInfoForm" id="disbursementInfoForm" class="form-horizontal form-widgets" role="form">
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-5 control-label label-required" for="paymentMethod">Payment Method:</label>
									<div class="col-md-5">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-md-5 control-label" for="isOtherBank">Select Other Bank:</label>
									<div class="col-md-5">
				...
				<div class="tab-pane" id="fragmentAmountInfo">
					<div class="panel-body">
						<form name="amountInfoForm" id="amountInfoForm" class="form-horizontal form-widgets" role="form">
							<g:render template='/exchangehouse/exhTask/feesForCustomer'/>
						</form>
					</div>
				</div>
			</div>
