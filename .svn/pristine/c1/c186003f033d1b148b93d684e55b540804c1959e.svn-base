...
/**
 *  Download Item Reconciliation report in CSV format
 *  For details go through Use-Case doc named 'DownloadForItemReconciliationCsvActionService'
 */
class DownloadForItemReconciliationCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String FAILURE_MSG = "Fail to generate item reconciliation csv report"
    ...
    private static final String JASPER_FILE = 'itemReconciliationCsv.jasper'
