...
/**
 *  Show list of acc voucher receive cash for grid
 *  For details go through Use-Case doc named 'ListAccVoucherReceiveCashActionService'
 */
class ListAccVoucherReceiveCashActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get acc voucher list of receive cash for grid
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // Get voucher list of receive cash by using dynamic finder
    ...
    /**
     * Wrap acc voucher list of receive cash for grid
    ...
    /**
     * Wrap list of acc voucher for receive cash in grid entity
     * @param voucherList -list of acc voucher for receive cash object(s)
     * @param start -starting index of the page
     * @return -list of wrapped accVouchers of receive cash
     */
