...
/**
 *  Show list of un-approved pay cash for grid
 *  For details go through Use-Case doc named 'ListUnApprovedPayCashActionService'
 */
class ListUnApprovedPayCashActionService extends BaseService implements ActionIntf {
    ...
    private static final String SERVER_ERROR_MESSAGE = "Fail to get un-posted pay cash list"
    ...
    /**
     * Get list of un-approved pay cash for grid
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // Get un-approved pay cash using dynamic finder
    ...
    /**
     * Wrap un-approved pay cash list for grid
    ...
    /**
     * Wrap list of un-approved pay cash in grid entity
     * @param voucherList -list of un-approved pay cash object(s)
     * @param start -starting index of the page
     * @return -list of wrapped un-approved pay cash
     */
