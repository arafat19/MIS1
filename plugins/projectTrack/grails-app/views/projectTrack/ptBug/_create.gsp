<%@ page import="com.athena.mis.projecttrack.utility.PtBacklogStatusCacheUtility; com.athena.mis.projecttrack.utility.PtBugStatusCacheUtility; com.athena.mis.application.utility.SystemEntityTypeCacheUtility" %>
<div id="application_top_panel" class="panel panel-primary">
    ...
    <g:form id='ptBugForm' name='ptBugForm' enctype="multipart/form-data" class="form-horizontal form-widgets"
            role="form">
        <div class="panel-body">
            ...
            <app:systemEntityByReserved
                    name="bugStatusFixed"
                    reservedId="${PtBugStatusCacheUtility.FIXED_RESERVED_ID}"
                    typeId="${SystemEntityTypeCacheUtility.PT_BUG_STATUS}">
            </app:systemEntityByReserved>
            <app:systemEntityByReserved
                    name="bugStatusClosed"
                    reservedId="${PtBugStatusCacheUtility.CLOSED_RESERVED_ID}"
                    typeId="${SystemEntityTypeCacheUtility.PT_BUG_STATUS}">
            </app:systemEntityByReserved>
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea type="text" class="k-textbox" id="stepToReproduce" name="stepToReproduce" rows="3"
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="file" tabindex="7" id="contentObj" name="contentObj"/>
                        </div>
                    </div>
                </div>
            </div>
