 ...
 * For details go through Use-Case doc named 'DownloadForTrialBalanceCsvOfLevel2ActionService'
 */
class DownloadForTrialBalanceCsvOfLevel2ActionService extends BaseService implements ActionIntf {
    ...
    private static final String TRIAL_BALANCE_JASPER_CSV = 'trialBalanceOfLevel2Csv.jasper'
    ...
    private List<GroovyRowResult> getTrialBalanceListOfLevel2(Date fromDate, Date toDate, List<Long> projectIdList,
        ...
        String strQuery = """
            ...
            AND coa.tier1 > 0
            GROUP BY coa.acc_type_id,t1.name,type.order_id
