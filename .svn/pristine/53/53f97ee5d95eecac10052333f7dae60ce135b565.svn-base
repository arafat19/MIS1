 ...
 *  For details go through Use-Case doc named 'ListPtAcceptanceCriteriaActionService'
 */
class ListPtAcceptanceCriteriaActionService extends BaseService implements ActionIntf {
