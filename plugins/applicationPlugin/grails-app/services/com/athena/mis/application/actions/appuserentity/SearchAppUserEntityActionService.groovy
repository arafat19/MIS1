...
/**
 *  Get list of AppUserEntity objects through specific search by key word to show on grid
 *  For details go through Use-Case doc named 'SearchAppUserEntityActionService'
 */
class SearchAppUserEntityActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Can't search app user entity list"
     ...
     * 2. get list of AppUserEntity(user entity mapping) object(s) for grid through specific search by key word
    ...
    private Map listOfAppUserEntity(long entityTypeId, long entityId) {
        ...
        List<GroovyRowResult> lstResult = executeSelectSql(lstQuery, queryParams)
