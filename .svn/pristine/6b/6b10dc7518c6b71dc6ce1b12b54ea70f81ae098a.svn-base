...
class GetDropDownInventoryProductionLineItemTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            String html = buildDropDown(lstProductionLineItem, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
