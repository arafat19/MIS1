...
/**
 *  Show UI for item CRUD (Category : FixedAsset) and list of FixedAsset item(s) for grid
 *  For details go through Use-Case doc named 'ShowItemCategoryFixedAssetActionService'
 */
class ShowItemCategoryFixedAssetActionService extends BaseService implements ActionIntf {
    ...
    /**
     * check access permission to show fixedAsset item CRUD page
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            //Only admin has right to show fixedAsset item CRUD page
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List resultItemList = wrapListInGridEntityList(itemList, start)
            Map output = [page: pageNumber, total: count, rows: resultItemList]
