...
/**
 *  Show list of un-approved journal for grid
 *  For details go through Use-Case doc named 'ListUnApprovedJournalActionService'
 */
class ListUnApprovedJournalActionService extends BaseService implements ActionIntf {
    ...
    private static final String SERVER_ERROR_MESSAGE = "Fail to get un-posted journal list"
    ...
    /**
     * Get list of un-approved journal for grid
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // Get un-approved journal using dynamic finder
    ...
    /**
     * Wrap un-approved journal list for grid
    ...
    /**
     * Wrap list of un-approved journal in grid entity
     * @param voucherList -list of un-approved journal object(s)
     * @param start -starting index of the page
     * @return -list of wrapped un-approved journal
     */
