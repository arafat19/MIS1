...
class ListNewTaskForSendToSarbActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get parameters from UI and list,count all new task from db
     * @param parameters
     * @param obj -N/A
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            List<SarbTaskModel> lstSarbTaskModel = sarbTaskModelService.listAllTaskForSendToSarb(lstStatusForSendTask, companyId, 0L, this)
            int count = sarbTaskModelService.countAllTaskForSendToSarb(lstStatusForSendTask, companyId, 0L)
