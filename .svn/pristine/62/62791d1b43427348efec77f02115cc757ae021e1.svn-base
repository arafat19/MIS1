...
/**
 * Download PDF report of Budget Wise QS
 * For details go through Use-Case doc named 'DownloadForBudgetWiseQsActionService'
 */
class DownloadForBudgetWiseQsActionService extends BaseService implements ActionIntf {
    ...
    private static final String BUDGET_WISE_QS = 'budgetWiseQs.jasper'
    ...
    /**
     * Generate Budget wise QS pdf report
    ...
    private Map getBudgetWiseQsReport(long projectId, Date fromDate, Date toDate, String projectName, Boolean isGovtQs) {
        ...
        JasperReportDef reportDef = new JasperReportDef(name: BUDGET_WISE_QS, fileFormat: JasperExportFormat.PDF_FORMAT,
