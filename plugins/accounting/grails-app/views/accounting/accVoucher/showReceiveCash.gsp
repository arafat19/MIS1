<div class="form-group">
    <div class="form-group col-md-9">
            ...
            <div id="createVoucherPanel" class="panel-body" style="height: 335px">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="fragment-1">
                        <g:render template='/accounting/accVoucher/basicInfoReceiveCash'/>
                    </div>

                    <div class="tab-pane" id="fragment-2">
                        <g:render template='/accounting/accVoucher/debitReceiveCash'/>
                    </div>

                    <div class="tab-pane" id="fragment-3">
                        <g:render template='/accounting/accVoucher/creditReceiveCash'/>
                    </div>
        ...
        <div class="form-group">
            <app:ifAllUrl urls="/accVoucher/listReceiveCash">
...
<g:render template='/accounting/accVoucher/scriptReceiveCash'/>
