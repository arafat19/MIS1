...
/**
 * Download CSV report of Budget Financial Summary
 * For details go through Use-Case doc named 'DownloadForBudgetFinancialCsvSummaryActionService'
 */
class DownloadForBudgetFinancialCsvSummaryActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Fail to download Budget Financial CSV Summary."
    ...
    private static final String OUTPUT_FILE_NAME = 'budgetFinancialCsvSummary'
    private static final String REPORT_TITLE = 'Budget Financial Csv Summary Report'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'budgetFinancialCsvSummary.jasper'
     ...
     * 2. Get map of report by getBudgetFinancialCsvSummaryReport method
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getBudgetFinancialCsvSummaryReport(projectId, fromDate, toDate, projectName, isGovtQs)
    ...
    /**
     * Generate Budget Financial Summary CSV report
     ...
     */
    private Map getBudgetFinancialCsvSummaryReport(long projectId, Date fromDate, Date toDate, String projectName, boolean isGovtQs) {
