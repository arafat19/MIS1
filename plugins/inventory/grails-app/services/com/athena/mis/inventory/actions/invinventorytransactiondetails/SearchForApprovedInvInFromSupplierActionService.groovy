...
/**
 *  Get specific list of approved inventory transaction details(Inventory In From Supplier) for grid through search
 *  For details go through Use-Case doc named 'SearchForApprovedInvInFromSupplierActionService'
 */
class SearchForApprovedInvInFromSupplierActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get approved inventory transaction details(Inventory In From Supplier) list for grid through specific search
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // get list and count of approved inventory transaction details(Inventory In From Supplier)
    ...
    /**
     * Get list and count of approved inventory transactions details(Inventory In From Supplier) by specific search key
