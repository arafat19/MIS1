...
/**
 *  Adjust approved inventory out transaction details object
 *  For details go through Use-Case doc named 'AdjustmentForInvOutActionService'
 */
class AdjustmentForInvOutActionService extends BaseService implements ActionIntf {

    private final Logger log = Logger.getLogger(getClass())

    private static final String ADJUSTMENT_SAVE_SUCCESS_MESSAGE = "Adjustment has been saved successfully"
    private static final String ADJUSTMENT_SAVE_FAILURE_MESSAGE = "Can not save the adjustment"
    ...
    private static final String ALREADY_ACK_ERROR = "Acknowledged transaction is not adjustable"
    ...
    /**
     * Checking pre condition before doing adjustment of inventory out transaction details object
    ...
    public Object executePreCondition(Object params, Object obj) {
        ...
        try {
            ...
            long adjustmentParentId = Long.parseLong(parameterMap.id)
            ...
            // get current inventory transaction details object
            ...
            // adjustment can not be done for already acknowledged transaction details object
            ...
            // check if adjustment quantity and actual quantity of current object is same
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            // calculate rate of item for adjustment
    ...
    /**
     * Show adjusted inventory transaction out details object in grid
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            object.cell = [
                    ...
                    adjDetails.mrfNo,
                    vehicle.name,
                    adjDetails.vehicleNumber ? adjDetails.vehicleNumber : Tools.EMPTY_SPACE,
                    createdBy.username,
                    approvedOn,
                    approvedBy.username
            ]
