...
/**
 * download supplier wise payable details in pdf format
 * For details go through Use-Case doc named 'AccDownloadForSupplierWisePayableActionService'
 */
class AccDownloadForSupplierWisePayableActionService extends BaseService implements ActionIntf {
    ...
    private Map getSupplierWisePayableReport(Project project, List<Long> projectIdList, Date fromDate, Date toDate) {
        ...
        // generated report name(e.g-supplierWisePayable.pdf)
