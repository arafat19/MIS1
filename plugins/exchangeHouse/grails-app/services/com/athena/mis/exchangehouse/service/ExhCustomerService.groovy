...
class ExhCustomerService extends BaseService {
    ...
    /**
     * 1.update isBlocked as true for block customer or
     * 2.update isBlocked as false for unblock customer
     * @param exhCustomer - exhCustomer obj
     */
    public int updateIsBlockedCustomer(ExhCustomer exhCustomer){
        Map queryParams=[
                companyId:exhCustomer.companyId,
                id:exhCustomer.id,
                isBlocked: exhCustomer.isBlocked,
