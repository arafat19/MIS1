 ...
 *  For details go through Use-Case doc named 'ShowAgentTaskForAdminActionService'
 */
class ShowAgentTaskForAdminActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            endDateStr = DateUtility.setLastHour(endDateStr)                  // set last hour ie 23:59:59
            ...
            result = [           // build a map for UI
                    ...
                    createdDateFrom: DateUtility.getDateForUI(startDateStr),       // set UI date format ie 'dd/MM/yyyy'
            ]
            return result
        } catch (Throwable e) {
            log.error(e.message)
