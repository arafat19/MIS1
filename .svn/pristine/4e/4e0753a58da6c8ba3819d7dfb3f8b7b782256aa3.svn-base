...
class SearchDocCategoryActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map searchResult = docCategoryCacheUtility.search(queryType, query, this)

            List<DocCategory> categoryList = (List<DocCategory>) searchResult.list
