 ...
 */
class DownloadForIncomeStatementCsvOfLevel5ActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Fail to download Income Statement Level 5"
    ...
    private static final String INCOME_STATEMENT_REPORT_CSV = 'incomeStatementCsvForHierarchy5.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            List<GroovyRowResult> incomeStatementList = getIncomeStatementListOfLevel5(fromDate, toDate, lstProjectIds, postedByParam, divisionId)
    ...
    private List<GroovyRowResult> getIncomeStatementListOfLevel5(Date fromDate, Date toDate, List<Long> projectIdList,
