...
/**
 *  Class to get search result list of supplierObject to show on grid
 *  For details go through Use-Case doc named 'SearchSupplierActionService'
 */
class SearchSupplierActionService extends BaseService implements ActionIntf {

    private final Logger log = Logger.getLogger(getClass())

    private static String PAGE_LOAD_ERROR_MESSAGE = "Failed to search supplier grid"
    ...
    /**
     * check access permission to search supplierList
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            //Only admin has right to search supplierObjectList
    ...
    public Object execute(Object parameters, Object obj = null) {
        try {
            ...
            initSearch(params)
            Map searchResult = supplierCacheUtility.search(queryType, query, this)
            List<Supplier> supplierList = searchResult.list
    ...
    private List wrapListInGridEntityList(List<Supplier> supplierList, int start) {
        ...
        for (int i = 0; i < supplierList.size(); i++) {
            ...
            SystemEntity supplierType = (SystemEntity) supplierTypeCacheUtility.read(supplier.supplierTypeId)
