...
class GetDropDownCurrencyTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<Currency> lstCurrency = currencyCacheUtility.list()
    ...
    private String buildDropDown(List<Currency> lstCurrency, Map dropDownAttributes) {
        ...
        if (showHints.booleanValue()) {
            lstCurrency = Tools.listForKendoDropdown(lstCurrency, null, hintsText)  // the null parameter indicates that dataTextField is name
        }
