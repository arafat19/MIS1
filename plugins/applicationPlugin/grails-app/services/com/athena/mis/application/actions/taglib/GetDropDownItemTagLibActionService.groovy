...
class GetDropDownItemTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            if (strTypeId) {
                ...
                dropDownAttributes.put(TYPE_ID, null)
            }
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List lstItem = []
            if (dropDownAttributes.get(TYPE_ID)) {
                Long itemTypeId = (Long) dropDownAttributes.get(TYPE_ID)
                lstItem = itemCacheUtility.listByItemTypeId(itemTypeId)
            } else {
                lstItem = itemCacheUtility.list()
            }
