...
/**
 * Download Csv of Consumption Against Asset Details.
 * For details go through Use-Case doc named 'DownloadCSVForConsumptionAgainstAssetDetailsActionService'
 */
class DownloadCSVForConsumptionAgainstAssetDetailsActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Fail to generate consumption details list CSV Report."
    ...
    private static final String REPORT_TITLE = 'Consumption Against Asset Details CSV Report'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'consumptionAgainstAssetDetailsCsv.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            if (params.fixedAssetDetailsId.equals(Tools.EMPTY_SPACE)) {//For All FixedAsset
