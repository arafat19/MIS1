 ...
 * For details go through Use-Case doc named 'DownloadForInventoryTransactionListActionService'
 */
class DownloadForInventoryTransactionListActionService extends BaseService implements ActionIntf {

    protected final Logger log = Logger.getLogger(getClass())

    private static final String DEFAULT_ERROR_MESSAGE = "Fail to generate inventory transaction list Report."
    ...
    private static final String JASPER_FILE_PDE = 'inventoryTransactionList.jasper'
    ...
    private Map getInventoryTransactionReport(GrailsParameterMap params, InvInventory invInventory,Date startDate, Date endDate, List transactionTypeIds, String transactionTypeName, long companyId, List<Long> lstItemTypeIds, String itemTypeName) {
        ...
        JasperReportDef reportDef = new JasperReportDef(name: JASPER_FILE_PDE, fileFormat: JasperExportFormat.PDF_FORMAT,
