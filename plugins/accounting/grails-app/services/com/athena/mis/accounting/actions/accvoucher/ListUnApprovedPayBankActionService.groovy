...
/**
 *  Show list of un-approved pay bank(cheque) for grid
 *  For details go through Use-Case doc named 'ListUnApprovedPayBankActionService'
 */
class ListUnApprovedPayBankActionService extends BaseService implements ActionIntf {
    ...
    private static final String SERVER_ERROR_MESSAGE = "Fail to get un-posted pay cheque list"
    ...
    /**
     * Get list of un-approved pay bank(cheque) for grid
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            // Get un-approved pay bank(cheque) using dynamic finder
            List<AccVoucher> voucherList = AccVoucher.findAllByVoucherTypeIdAndCompanyId(voucherTypeObj.id, accSessionUtil.appSessionUtil.getCompanyId(), [offset: start, max: resultPerPage, sort: sortColumn, order: sortOrder, readOnly: true])
            int total = (int) AccVoucher.countByVoucherTypeIdAndCompanyId(voucherTypeObj.id, accSessionUtil.appSessionUtil.getCompanyId())
    ...
    /**
     * Wrap un-approved pay bank(cheque) list for grid
    ...
    /**
     * Wrap list of un-approved pay bank (cheque) in grid entity
     * @param voucherList -list of un-approved pay bank (cheque) object(s)
     * @param start -starting index of the page
     * @return -list of wrapped un-approved pay bank (cheque)
     */
