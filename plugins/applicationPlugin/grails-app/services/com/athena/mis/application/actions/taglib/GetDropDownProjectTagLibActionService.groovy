...
class GetDropDownProjectTagLibActionService extends BaseService implements ActionIntf {
    ...
    private List<Project> listProject(boolean filterMapping) {
        ...
        if (filterMapping) {
            lstProject = (List<Project>) appSessionUtil.getUserProjects()
        } else {
            lstProject = projectCacheUtility.list()
        }
        return lstProject
    }
