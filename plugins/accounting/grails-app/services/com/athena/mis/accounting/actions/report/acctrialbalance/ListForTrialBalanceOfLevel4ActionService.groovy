 ...
 */
class ListForTrialBalanceOfLevel4ActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get trial balance level 4 list
     * @param parameters - serialized parameters from UI
     * @param obj -N/A
     * @return - a map containing trial balance level 4 for grid and error msg(True/False)
     */
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            List<GroovyRowResult> returnTrailBalanceList = getTrialBalanceListOfLevel4(fromDate, toDate, lstProjectIds, postedByParam, divisionId)
     ...
     * @return - a map containing wrapped trial balance level 4 for grid and error msg(True/False)
     */
    ...
    /**
     * Wrap trial balance level 4 list for grid
    ...
    private List wrapTrialBalanceListInGridEntityList(List<GroovyRowResult> trialBalanceList) {
        ...
        GroovyRowResult eachCoa
        GridEntity object
        for (int i = 0; i < trialBalanceList.size(); i++) {
            eachCoa = trialBalanceList[i]
            object = new GridEntity()
            object.id = counter
            object.cell = [
                    counter,
                    eachCoa.description,
                    eachCoa.str_dr_balance,
                    eachCoa.str_cr_balance
            ]
            lstTrialBalance << object
            counter++

            totalSumOfDebit = totalSumOfDebit + eachCoa.dr_balance
            totalSumOfCredit = totalSumOfCredit + eachCoa.cr_balance
        }
     ...
     * @return - list for trial balance level 4
     */
    private List<GroovyRowResult> getTrialBalanceListOfLevel4(Date fromDate, Date toDate, List<Long> projectIdList,
