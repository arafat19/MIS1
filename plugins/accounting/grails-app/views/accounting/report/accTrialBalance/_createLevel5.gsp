<div id="application_top_panel" class="panel panel-primary">
    ...
    <form id="searchForm" name="searchForm" class="form-horizontal form-widgets" role="form">
        ...
        <div class="panel-footer">
            ...
            <app:ifAnyUrl urls="/accReport/downloadTrialBalanceOfLevel5,/accReport/downloadTrialBalanceCsvOfLevel5">
                <span class="download_icon_set">
                    <ul>
                        <li>Save as :</li>
                        <app:ifAllUrl urls="/accReport/downloadTrialBalanceOfLevel5">
                            <li><a href="javascript:void(0)" id="printTrialBalancePdf" class="pdf_icon"></a></li>
                        </app:ifAllUrl>
                        <app:ifAllUrl urls="/accReport/downloadTrialBalanceCsvOfLevel5">
