 ...
 */
class DownloadForItemReceivedStockActionService extends BaseService implements ActionIntf {
    ...
    private static final String JASPER_FILE_PDF = 'itemReceivedStock.jasper'
