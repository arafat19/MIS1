...
/**
 *  Select ptBug object for my task
 *  For details go through Use-Case doc named 'SelectPtBugForMyTaskActionService'
 */
class SelectPtBugForMyTaskActionService extends BaseService implements ActionIntf {
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            result.put(SEVERITY, severity.key)
            result.put(TYPE, type.key)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            return result
        } catch (Exception e) {
            log.error(e.getMessage())
