...
/**
 *  Show received cash voucher in the grid
 *  For details go through Use-Case doc named 'ShowAccVoucherReceiveCashActionService'
 */
class ShowAccVoucherReceiveCashActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get receive cash voucher list for grid
    ...
    /**
     * Wrap received cash voucher list for grid
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            long companyId = accSessionUtil.appSessionUtil.getCompanyId()
            SystemEntity accVoucherTypeReceiveCash = (SystemEntity) accVoucherTypeCacheUtility.readByReservedAndCompany(accVoucherTypeCacheUtility.RECEIVED_VOUCHER_CASH_ID, companyId)
            List lstCoaVoucherType = accVoucherTypeCoaCacheUtility.listCoa(accVoucherTypeReceiveCash)
    ...
    /**
     * Wrap list of receive cash voucher in grid entity
     * @param voucherList -list of receive cash voucher object(s)
     * @param start -starting index of the page
     * @return -list of wrapped receive cash voucher
     */
