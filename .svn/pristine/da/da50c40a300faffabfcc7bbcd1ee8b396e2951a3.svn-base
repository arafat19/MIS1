...
class ExhShowSanctionFromCustomerActionService extends BaseService implements ActionIntf {
    ...
    Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            params.rp = 25
            initPager(params)
            Map serviceReturn = listOfSuspectSanctionForCustomer(customerName)
            executeResult.put(SERVICE_RETURN_OBJ, serviceReturn)

            executeResult.put(CUSTOMER_NAME, customerName)
    ...
    public Object buildSuccessResultForUI(Object result) {
        ...
        try {
            ...
            successResult.put(CUSTOMER_NAME, executeReturn.customerName)
