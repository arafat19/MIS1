...
/**
 * Download Invoice in pdf format for Agent, Cashier or Admin
 * For details go through Use-Case doc named 'ExhDownloadTaskInvoiceReportActionService'
 */
class ExhDownloadTaskInvoiceReportActionService extends BaseService implements ActionIntf {
     ...
     * 3. check another agent task
     * 4. check task status PENDING, UN-APPROVED or task type of CUSTOMER
