 ...
 * For details go through Use-Case doc named 'DownloadForTrialBalanceCsvOfLevel3ActionService'
 */
class DownloadForTrialBalanceCsvOfLevel3ActionService extends BaseService implements ActionIntf {
    ...
    private static final String TRIAL_BALANCE_JASPER_CSV = 'trialBalanceOfLevel3Csv.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            List<GroovyRowResult> trailBalanceList = getTrialBalanceListOfLevel3(fromDate, toDate, lstProjectIds, postedByParam, divisionId)
