 ...
 *  For details go through Use-Case doc named 'ExhSearchForCustomerActionService'
 */
class ExhSearchForCustomerActionService extends BaseService implements ActionIntf {
	...
	Object execute(Object parameters, Object obj) {
		...
		try {
			...
			List<ExhBeneficiary> lstBeneficiary = findAllByCustomerId(customerId, isApproved)
	...
	public Object buildSuccessResultForUI(Object obj) {
		...
		try {
			...
			List wrapBeneficiaries = wrapBeneficiaryList(lstBeneficiary, start)
	...
	private List<ExhBeneficiary> findAllByCustomerId(long customerId, boolean isApproved) {
        ...
        SELECT *
            ...
            ORDER BY exh_beneficiary.${sortColumnStr} ${sortOrder} OFFSET ${start} LIMIT ${resultPerPage}
        """
