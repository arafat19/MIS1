...
/**
 *  Class to get list of accGroup object(s) to show on grid
 *  For details go through Use-Case doc named 'ListAccGroupActionService'
 */
class ListAccGroupActionService extends BaseService implements ActionIntf {
