   ...
   * */
    ...
    * */
    ...
    private DocSubCategory buildSubCategory(GrailsParameterMap parameterMap, DocSubCategory oldSubCategory, DocCategory category) {
        ...
        String url = grailsLinkGenerator.link(controller: 'docSubCategory', action: 'showSubCategory', params: [category: category.id, sub: oldSubCategory.id], absolute: true)
        ...
        oldSubCategory.isEmailNotification = newSubCategory.isEmailNotification
