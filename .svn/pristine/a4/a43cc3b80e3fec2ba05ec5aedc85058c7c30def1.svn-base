...
/**
 * Download CSV report of QS Measurement
 * For details go through Use-Case doc named 'DownloadForQsMeasurementCsvActionService'
 */
class DownloadForQsMeasurementCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String REPORT_FOLDER = 'qsMeasurement'
    private static final String OUTPUT_FILE_NAME = 'qsMeasurementCSV'
    private static final String REPORT_TITLE = 'QS Measurement Report'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'qsMeasurementCSV.jasper'
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            boolean isGovtQs = Boolean.parseBoolean(params.isGovtQs.toString())
     ...
     * 2. Get map of report by getBudgetWiseQsMeasurementReport method
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getBudgetWiseQsMeasurementReport(projectId, fromDate, toDate, projectName, isGovtQs)
    ...
    public Object buildFailureResultForUI(Object obj) {
        ...
        try {
            ...
            result.put(Tools.IS_ERROR, receivedResult.get(Tools.IS_ERROR))
            if (receivedResult.message) {
    ...
    /**
     * Generate QS Measurement CSV report
     ...
     */
    private Map getBudgetWiseQsMeasurementReport(long projectId, Date fromDate, Date toDate, String projectName, Boolean isGovtQs) {
