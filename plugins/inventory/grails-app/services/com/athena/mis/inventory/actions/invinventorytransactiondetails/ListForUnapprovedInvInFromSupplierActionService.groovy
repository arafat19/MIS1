...
/**
 *  Show unapproved list of inventory transaction details(Inventory In From Supplier) for grid
 *  For details go through Use-Case doc named 'ListForUnapprovedInvInFromSupplierActionService'
 */
class ListForUnapprovedInvInFromSupplierActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get inventory transaction details list (Inventory In From Supplier) for grid
