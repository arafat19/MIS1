...
/**
 * Select the object of  Maintenance Type.
 * For details go through Use-Case doc named 'FxdSelectFxdMaintenanceTypeActionService'
 */
class FxdSelectFxdMaintenanceTypeActionService extends BaseService implements ActionIntf {

    private final Logger log = Logger.getLogger(getClass())

    private static final String NOT_FOUND_MASSAGE = "Selected maintenance type is not found"
    ...
    /**
     * 1. check maintenance type existence
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            FxdMaintenanceType fxdMaintenanceType = (FxdMaintenanceType) executeResult.get(FXD_MAINTENANCE_TYPE)
            result.put(Tools.ENTITY, fxdMaintenanceType)
