            ...
            <div id="createVoucherPanel" class="panel-body" style="height: 335px">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="fragment-1">
                        <g:render template='/accounting/accVoucher/basicInfoPayCash'/>
                    </div>

                    <div class="tab-pane" id="fragment-2">
                        <g:render template='/accounting/accVoucher/debitPayCash'/>
                    </div>

                    <div class="tab-pane" id="fragment-3">
                        <g:render template='/accounting/accVoucher/creditPayCash'/>
                    </div>
...
<g:render template='/accounting/accVoucher/scriptPayCash'/>
