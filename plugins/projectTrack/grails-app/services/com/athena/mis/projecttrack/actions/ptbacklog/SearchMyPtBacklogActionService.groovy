 ...
 *  For details go through Use-Case doc named 'SearchMyPtBacklogActionService'
 */
class SearchMyPtBacklogActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            List lstBacklog = searchReturn.backlogList
     ...
     * @return -a map contains search result list of backlog and count
     */
    private LinkedHashMap searchResult(String queryParameter) {
        ...
        return [backlogList: results, count: count]
    }
}
