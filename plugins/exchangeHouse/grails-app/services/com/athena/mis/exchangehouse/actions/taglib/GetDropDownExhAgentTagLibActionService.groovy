...
class GetDropDownExhAgentTagLibActionService extends BaseService implements ActionIntf{
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            List<ExhAgent> lstAgent = exhAgentCacheUtility.list()
     ...
     * @return - html string for select
     */
    private String buildDropDown(List<ExhAgent> lstAgent, Map dropDownAttributes) {
        // read map values
