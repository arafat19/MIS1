...
class DeleteBackLogForSprintActionService extends BaseService implements ActionIntf {
    ...
    private static final String DELETE_ONLY_DEFINED_STATUS = "Only defined backlog could be removed"
    ...
    public Object executePreCondition(Object params, Object obj) {
        ...
        try {
            ...
            boolean hasRole = ptSessionUtil.appSessionUtil.hasRole(roleTypeCacheUtility.ROLE_SOFTWARE_PROJECT_ADMIN)

            if (backlog.ownerId > 0 && !hasRole) {
