...
/*
 * Search budget sprint and show data for grid
 * For details go through Use-Case doc named 'SearchForBudgetSprintActionService'
 */
class SearchForBudgetSprintActionService extends BaseService implements ActionIntf {
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            long sprintId
            try {
                sprintId = Long.parseLong(params.sprintId)
            } catch (Exception ex) {
                result.put(Tools.MESSAGE, INVALID_SPRINT_ID)
                return result
            }
