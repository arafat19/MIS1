 ...
 * For details go through Use-Case doc named 'DownloadForFinancialStatementOfLevel4ActionService'
 */
class DownloadForFinancialStatementOfLevel4ActionService extends BaseService implements ActionIntf {
    ...
    private static final String REPORT_FOLDER = 'accFinancialStatement' + File.separator + 'level4'
    private static final String OUTPUT_FILE_NAME = 'accFinancialStatementOfLevel4'
    private static final String REPORT_TITLE = 'accFinancialStatementOfLevel4'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String SUBREPORT_DIR = 'SUBREPORT_DIR'
    private static final String REPORT = "report"
    private static final String ACC_FINANCIAL_STATEMENT_REPORT = 'accFinancialStatementOfLevel4.jasper'
