...
/**
 *  Get list of all inventory by inventory type (store/site) for drop down
 *  For details go through Use-Case doc named 'GetAllInventoryListByInventoryTypeActionService'
 */
class GetAllInventoryListByInventoryTypeActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Fail to load All inventory list"
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            // get list of all inventory by inventory type (store/site)
            List<Object> inventoryList = invInventoryCacheUtility.listByType(inventoryTypeId)

            result.put(INVENTORY_LIST, Tools.listForKendoDropdown(inventoryList, null, null))
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            return result
        } catch (Exception ex) {
            log.error(ex.getMessage())
