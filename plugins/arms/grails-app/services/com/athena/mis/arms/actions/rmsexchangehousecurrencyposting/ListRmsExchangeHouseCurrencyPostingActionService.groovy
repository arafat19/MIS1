...
/**
 *  Get list of RmsExchangeHouseCurrencyPosting
 *  For details go through Use-Case doc named 'ListRmsExchangeHouseCurrencyPostingActionService'
 */
class ListRmsExchangeHouseCurrencyPostingActionService extends BaseService implements ActionIntf {
    ...
    private static final String SHOW_EXH_HOUSE_CUR_POSTING_FAILURE_MESSAGE = "Failed to load exchange house currency posting page"
    ...
    Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            // get count of ExchangeHouseCurrencyPosting from DB
            ...
            result.put(Tools.MESSAGE, SHOW_EXH_HOUSE_CUR_POSTING_FAILURE_MESSAGE)
            return result
        }
    }
     ...
     * @param lstExcHouseCurPosting -list of ExchangeHouseCurrencyPosting object(s)
    ...
    private List<GroovyRowResult> list(BaseService baseService) {
        ...
        List<GroovyRowResult> lstExhHouseCurPosting = executeSelectSql(queryStr, queryParams)
        return lstExhHouseCurPosting
    }
}
