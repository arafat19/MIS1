...
/**
 *  Show UI for item CRUD (Category : Inventory) and list of Inventory item(s) for grid
 *  For details go through Use-Case doc named 'ShowItemCategoryInventoryActionService'
 */
class ShowItemCategoryInventoryActionService extends BaseService implements ActionIntf {

    private final Logger log = Logger.getLogger(getClass())

    private static final String PAGE_LOAD_ERROR_MESSAGE = "Could not load item page"
    ...
    /**
     * check access permission to show inventory item CRUD page
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            //Only admin has right to show inventory item CRUD page
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List resultInventoryList = wrapListInGridEntityList(itemList, start)
            Map output = [page: pageNumber, total: count, rows: resultInventoryList]
