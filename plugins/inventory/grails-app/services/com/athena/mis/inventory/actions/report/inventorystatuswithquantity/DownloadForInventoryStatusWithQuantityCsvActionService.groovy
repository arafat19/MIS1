...
/**
 *  Download Inventory Status with quantity report in CSV format
 *  For details go through Use-Case doc named 'DownloadForInventoryStatusWithQuantityCsvActionService'
 */
class DownloadForInventoryStatusWithQuantityCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String FAILURE_MSG = "Fail to generate inventory status with quantity report"
    private static final String REPORT_FOLDER = 'inventoryStatusWithQuantity'
    private static final String REPORT = "report"
    private static final String OUTPUT_FILE_NAME = 'inventoryStatusWithQuantityCsv'
    ...
    private static final String REPORT_TITLE = 'Inventory Status With Quantity Csv'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'inventoryStatusWithQuantityCsv.jasper'
