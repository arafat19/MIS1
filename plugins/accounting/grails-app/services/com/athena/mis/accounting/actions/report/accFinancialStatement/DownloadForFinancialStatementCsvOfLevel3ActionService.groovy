...
/**
 * Download  financial statement in csv format for level 3
 * Report will contain coa of tier1 & tier2(if any) and sum of tier3
 * For details go through Use-Case doc named 'DownloadForFinancialStatementCsvOfLevel3ActionService'
 */
class DownloadForFinancialStatementCsvOfLevel3ActionService extends BaseService implements ActionIntf {
    ...
    private static final String ACC_BALANCE_SHEET_REPORT_CSV = 'financialStatementOfLevel3Csv.jasper'
