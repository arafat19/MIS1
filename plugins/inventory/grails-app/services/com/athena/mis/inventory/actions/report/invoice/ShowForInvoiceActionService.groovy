...
/**
 * Show UI for chalan report and show chalan report if navigated from another page
 * For details go through Use-Case doc named 'ShowForInvoiceActionService'
 */
class ShowForInvoiceActionService extends BaseService implements ActionIntf {
    ...
    /**
     * If navigated from another page then
     * 1. get inventory transaction and transaction details object by id
     * 2. build a map with necessary information to show invoice
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            // if navigated from another page then get inventory transaction and transaction details object
            if (params.id) {
