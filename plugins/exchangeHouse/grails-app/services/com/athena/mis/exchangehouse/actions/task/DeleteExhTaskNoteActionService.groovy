...
/**
 *  Delete task entityNote object from DB and remove it from grid for admin
 *  For details go through Use-Case doc named 'DeleteExhTaskNoteActionService'
 */
class DeleteExhTaskNoteActionService extends BaseService implements ActionIntf {
