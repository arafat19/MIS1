<div class="form-group">
    <div class="form-group col-md-9">
            ...
            <div id="createVoucherPanel" class="panel-body" style="height: 335px">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="fragment-1">
                        <g:render template='/accounting/accVoucher/basicInfo'/>
                    </div>

                    <div class="tab-pane" id="fragment-2">
                        <g:render template='/accounting/accVoucher/debit'/>
                    </div>

                    <div class="tab-pane" id="fragment-3">
                        <g:render template='/accounting/accVoucher/credit'/>
                    </div>
        ...
        <div class="form-group">
            <app:ifAllUrl urls="/accVoucher/list">
...
<g:render template='/accounting/accVoucher/script'/>
