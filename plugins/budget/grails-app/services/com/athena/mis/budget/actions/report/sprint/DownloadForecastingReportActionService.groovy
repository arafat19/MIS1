...
/**
 * Download forecasting report for sprint
 * For details go through Use-Case doc named 'DownloadForecastingReportActionService'
 */
class DownloadForecastingReportActionService extends BaseService implements ActionIntf {
    ...
    private static final String FAILURE_MSG = "Fail to download forecasting report"
    private static final String REPORT_FILE_FORMAT = 'pdf'
    private static final String REPORT_NAME_FIELD = 'REPORT_NAME'
    private static final String REPORT_FOLDER = 'budgSprint'
    private static final String OUTPUT_FILE_NAME = 'forecasting_report'
    private static final String REPORT_TITLE = 'Forecasting Report'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String SUBREPORT_DIR = 'SUBREPORT_DIR'
    private static final String JASPER_FILE_PDF = 'forecastingReport.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getForecastingReport(sprint)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
     ...
     */
    private Map getForecastingReport(BudgSprint sprint) {
