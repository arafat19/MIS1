...
/**
 *  download task report for issue Online
 *  For details go through Use-Case doc named 'DownloadTaskReportForIssueOnlineActionService'
 */
class DownloadTaskReportForIssueOnlineActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'issueOnline'
    private static final String CSV_EXTENSION = ".csv"

    private static final String REPORT_FILE_FORMAT = 'csv'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String JASPER_FILE = 'issueOnlineCsv.jasper'
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            Map report = getTaskReport(exhHouseId, exchangeHouseName, taskListId, taskListName, currentStatus, processTypeId, instrumentTypeId, fromDate, toDate, companyCode,taskStatus)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
     ...
     */
    private Map getTaskReport(long exhHouseId, String exchangeHouseName, long taskListId, String taskListName, long currentStatus, long processTypeId, long instrumentTypeId, Timestamp fromDate, Timestamp toDate, String companyCode,String taskStatus) {
