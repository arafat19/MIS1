 ...
 * For details go through Use-Case doc named 'DownloadForTrialBalanceOfLevel5ActionService'
 */
class DownloadForTrialBalanceOfLevel5ActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'accTrialBalanceOfHierarchy5'
    private static final String REPORT_TITLE = 'accTrialBalance'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String REPORT = "report"
    private static final String TRIAL_BALANCE_JASPER = 'trialBalanceOfLevel5.jasper'
