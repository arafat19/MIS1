...
/**
 * Download bank reconciliation cheque in csv format.
 * For details go through Use-Case doc named 'AccDownloadForBankReconciliationChequeCsvActionService'
 */
class AccDownloadForBankReconciliationChequeCsvActionService extends BaseService implements ActionIntf {
    ...
    private static final String OUTPUT_FILE_NAME = 'bankReconciliationChequeCsv'
    private static final String REPORT_DIR = 'REPORT_DIR'
    private static final String REPORT = "report"
    private static final String BANK_RECONCILIATION_CHEQUE_JASPER = 'accBankReconciliationChequeCsv.jasper'
    ...
    private Map getBankReconciliationChequeReport(Date toDate) {
        ...
        JasperReportDef reportDef = new JasperReportDef(name: BANK_RECONCILIATION_CHEQUE_JASPER, fileFormat: JasperExportFormat.CSV_FORMAT,
