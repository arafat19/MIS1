<div id="application_top_panel" class="panel panel-primary">
    ...
    <form id="searchForm" name="searchForm" class="form-horizontal form-widgets" role="form">
        ...
        <div class="panel-footer">
            ...
            <app:ifAnyUrl
                    urls="/accReport/downloadIncomeStatementOfLevel5,/accReport/downloadIncomeStatementCsvOfLevel5">
                <span class="download_icon_set">
                    <ul>
                        <li>Save as :</li>
                        <app:ifAllUrl urls="/accReport/downloadIncomeStatementOfLevel4">
                            <li><a href="javascript:void(0)" id="printIncomeStatementPdf" class="pdf_icon"></a></li>
                            <li><a href="javascript:void(0)" id="printIncomeStatementCsv" class="csv_icon"></a></li>
                        </app:ifAllUrl>
                    </ul>
                </span>
            </app:ifAnyUrl>
