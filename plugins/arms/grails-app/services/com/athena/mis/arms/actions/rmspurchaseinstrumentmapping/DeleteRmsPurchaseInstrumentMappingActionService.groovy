...
class DeleteRmsPurchaseInstrumentMappingActionService extends BaseService implements ActionIntf {

    RmsPurchaseInstrumentMappingService rmsPurchaseInstrumentMappingService

    private final Logger log = Logger.getLogger(getClass())

    private static final String DEFAULT_ERROR_MESSAGE = "Failed to delete purchase instrument mapping"
    private static final String DELETE_SUCCESS_MSG = "Purchase instrument mapping has been successfully deleted"
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            long purchaseInstrumentMappingId = Long.parseLong(params.id)
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            rmsPurchaseInstrumentMappingService.delete(purchaseInstrumentMappingId)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            return result
        } catch (Exception ex) {
