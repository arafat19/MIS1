...
/**
 *  Get specific list of unapproved inventory transaction details(Inventory In From Inventory) for grid through search
 *  For details go through Use-Case doc named 'SearchForUnapprovedInvInFromInventoryActionService'
 */
class SearchForUnapprovedInvInFromInventoryActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get unapproved inventory transaction details(Inventory In From Inventory) list for grid through specific search
    ...
    private List wrapInventoryInDetailsList(List<GroovyRowResult> lstInventoryInDetails, int start) {
        List lstWrappedInventoryInDetails = [] as List
        int counter = start + 1
    ...
    /**
     * Get list and count of unapproved inventory transactions details(Inventory In From Inventory) by specific search key
