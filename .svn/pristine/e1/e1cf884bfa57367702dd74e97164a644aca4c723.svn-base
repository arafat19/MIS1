 ...
 *  For details go through Use-Case doc named 'ExhShowApprovedBeneficiariesForCustomerActionService'
 */
class ExhShowApprovedBeneficiariesForCustomerActionService extends BaseService implements ActionIntf {
    ...
    /**
     * Get list of approved beneficiary for grid
