...
/**
 *  Select ContentCategory object and show in UI for editing
 *  For details go through Use-Case doc named 'SelectContentCategoryActionService'
 */
class SelectContentCategoryActionService extends BaseService implements ActionIntf {

    private static final String NOT_FOUND_MASSAGE = "Selected content category not found"
    private static final String DEFAULT_ERROR_MASSAGE = "Failed to select content category"
    ...
    /**
     * Check if user has access to select ContentCategory
    ...
    public Object executePreCondition(Object parameters, Object obj) {
        ...
        try {
            ...
            // only development role type user can select ContentCategory
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            result.put(Tools.ENTITY, contentCategory)
    ...
    /**
     * Build a map with ContentCategory object & other related properties to show on UI
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            ContentCategory contentCategory = (ContentCategory) executeResult.get(Tools.ENTITY)
            result.put(Tools.IS_ERROR, Boolean.FALSE)
            result.put(Tools.ENTITY, contentCategory)
            result.put(Tools.VERSION, contentCategory.version)
            return result
        } catch (Exception e) {
            log.error(e.getMessage())
            result.put(Tools.IS_ERROR, Boolean.TRUE)
