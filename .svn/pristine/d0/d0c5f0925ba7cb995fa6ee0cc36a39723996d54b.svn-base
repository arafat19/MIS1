<script type="text/javascript">
    ...
    $(document).ready(function() {
        onLoadIssueOnlinePage();
    });
    // method called on page load
    function onLoadIssueOnlinePage() {
        initializeForm($("#filterPanelIssueOnlineForm"), onSubmitIssueOnlineFilterPanel);
        ...
        // update page title
        $(document).attr('title', "ARMS - Issue Online");
        loadNumberedMenu(MENU_ID_ARMS, "#rmsInstrument/showForIssueOnline");
    }
    ...
    function onSubmitIssueOnlineFilterPanel() {
        ...
        (
            {
                ...
                usepager: true,
                singleSelect: false,
                title: 'All Task of Issue Online',
                useRp: true,
                rp: 15,
    ...
    function downloadIssueOnline() {
        ...
        if (confirm('Do you want to download the CSV now?')) {
            ...
            var currentStatus = dropDownTaskStatus.value();
            var params = "?exhHouseId=" + exhHouseId + "&taskListId=" + taskListId + "&fromDate=" + fromDate + "&toDate=" + toDate + "&currentStatus=" + currentStatus + "&process=" + process + "&instrument=" + instrument;
            var url = "${createLink(controller: 'rmsInstrument', action: 'downloadTaskReportForIssueOnline')}" + params;
