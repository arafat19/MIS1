    ...
    <div class="panel-body">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <exh:checkSysConfig key="${ExhSysConfigurationIntf.EXH_PHOTO_ID_NO_REQUIRED}" value="1">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="k-textbox" id="photoIdNo" pattern="^.{2,20}$"
                               required validationMessage="Invalid" name="photoIdNo" tabindex="2"/>
                    </div>
                </exh:checkSysConfig>
                <div class="col-md-3 pull-left">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <app:dateControl id="customerPhotoIdExpiryDate" name="customerPhotoIdExpiryDate"
                                     tabindex="3" placeholder="dd/MM/yyyy" value="">
                    </app:dateControl>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <app:dateControl name="visaExpireDate"
                                     value=""
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <app:dateControl name="dateOfIncorporation"
                                     tabindex="7" placeholder="dd/MM/yyyy" value="" validationMessage="Required"
                                     disabled="true">
                    </app:dateControl>
