...
class ListDocSubCategoryActionService extends BaseService implements ActionIntf {
    ...
    * */
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            long id = Long.parseLong(params.categoryId.toString())
            List<DocSubCategory> lstSubCategory = docSubCategoryCacheUtility.listByCategoryId(id, this)
            //get list of sub category from DB
            int count = docSubCategoryCacheUtility.countByCategoryId(id)


            result.put(SUB_CATEGORY_LABEL, subCategoryName)
            result.put(LIST_SUB_CATEGORY, lstSubCategory)
