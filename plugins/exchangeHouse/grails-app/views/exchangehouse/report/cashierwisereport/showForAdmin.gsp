	...
	<form id='cashierWiseReportForAdmin' name='cashierWiseReportForAdmin' class="form-horizontal form-widgets" role="form">
		<div class="panel-body">
			<div class="form-group">
				...
				<label class="col-md-2 control-label label-required" for="cashierListId">Cashier List:</label>
				<div class="col-md-2">
					<exh:dropDownCashier dataModelName="dropDownCashier" tabindex="3" name="cashierListId">
					</exh:dropDownCashier>
				</div>
			</div>
		</div>
...
<g:render template='/exchangehouse/report/cashierwisereport/scriptForAdmin'/>