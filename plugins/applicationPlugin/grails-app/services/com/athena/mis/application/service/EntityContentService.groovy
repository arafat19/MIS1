...
class EntityContentService extends BaseService {
     ...
     * @return -object of EntityContent
     */
    public EntityContent findByEntityTypeIdAndEntityIdAndContentTypeIdAndContentCategoryId(long entityTypeId, long entityId, long contentTypeId,long contentCategoryId) {
        EntityContent entityContent = EntityContent.findByEntityTypeIdAndEntityIdAndContentTypeIdAndContentCategoryId(entityTypeId, entityId, contentTypeId,contentCategoryId, [readOnly: true])
        return entityContent
    }
