...
/**
 *  Show UI for inventory transaction details(Inventory In From Supplier) CRUD and list of unapproved inventory transaction details for grid
 *  For details go through Use-Case doc named 'ShowForUnapprovedInvInFromSupplierActionService'
 */
class ShowForUnapprovedInvInFromSupplierActionService extends BaseService implements ActionIntf {
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            result.put(INV_TRANS_ID, executeResult.get(INV_TRANS_ID))
    ...
    /**
     * Get list and count of unapproved inventory transactions details(Inventory In From Supplier)
