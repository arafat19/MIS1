...
/**
 *  Class to search approved inventory-production-with-consumption-details
 *  For details go through Use-Case doc named 'SearchForApprovedProductionWithConsumptionActionService'
 */
class SearchForApprovedProductionWithConsumptionActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            if (inventoryIds.size() > 0) { //if userMappedInventoryIds > 0 then get list of approvedProductionDetailsInfo of that Inventories
                serviceReturn = searchForApprovedProdWithConsump(inventoryIds)
    ...
    /**
     * Get SearchList of approved-Production-With-Consumption
     *
     ...
     */
    private Map searchForApprovedProdWithConsump(List<Long> lstInventories) {
