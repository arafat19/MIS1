    ...
    <form id='filterAgentForm' name='filterAgentForm' class="form-horizontal form-widgets" role="form">
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <app:dateControl name="createdDateFrom" value="${startDate}" tabindex="1"></app:dateControl>
                </div>

                <label class="col-md-2 control-label label-required" for="createdDateTo">End Date:</label>
                <div class="col-md-2">
                    <app:dateControl name="createdDateTo"  tabindex="2"></app:dateControl>
                </div>
        ...
        <div class="panel-footer">
            <button  name="searchCommission" id="searchCommission" type="submit" data-role="button"
