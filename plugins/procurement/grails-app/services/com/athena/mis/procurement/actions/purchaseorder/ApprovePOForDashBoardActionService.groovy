...
/**
 * Approve Purchase Order For showing on the Dash Board
 * For details go through Use-Case doc named 'ApprovePOForDashBoardActionService'
 */
class ApprovePOForDashBoardActionService extends BaseService implements ActionIntf {
    ...
    private static
    final String ALREADY_APPROVED_PROJECT_DIRECTOR = "Purchase Order already approved by project director."
    ...
    public Object executePreCondition(Object params, Object obj) {
        ...
        try {
            ...
            // user has no right to approve PR
    ...
    public Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            int purchaseOrderUpdateStatus = updateForApproval(purchaseOrderInstance)
            ...
            log.error(ex.getMessage());
            //@todo:rollback
            throw new RuntimeException("Fail to approve PO for DashBoard")
            result.put(Tools.IS_ERROR, Boolean.TRUE)
            result.put(Tools.MESSAGE, SERVER_ERROR_MESSAGE)
            return result
        }
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            AppUser user = (AppUser) appUserCacheUtility.read(purchaseOrderInstance.createdBy)
            ...
            if (purchaseOrderInstance.approvedByDirectorId > 0 && purchaseOrderInstance.approvedByProjectDirectorId > 0) {
                isBothApproved = true
            }
    ...
    public Object buildFailureResultForUI(Object obj) {
        ...
        try {
            ...
            if (receiveResult.message) {
                ...
                failureResult.put(Tools.MESSAGE, PURCHASE_ORDER_SAVE_FAILURE_MESSAGE)
            }
