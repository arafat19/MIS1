...
/**
 *  Search ptSprint and show specific list of sprints for grid
 *  For details go through Use-Case doc named 'PtSearchSprintActionService'
 */
class PtSearchSprintActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_ERROR_MESSAGE = "Failed to load ptSprint List"
    ...
    /**
     * Get ptSprint list for grid through specific search
    ...
    public Object execute(Object params, Object obj) {
        ...
        try {
            ...
            List<GroovyRowResult> lstSprint = search()
    ...
    public Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            List sprintList = (List) executeResult.get(LST_SPRINT)
     ...
     * @param lstSprint -list of ptSprint object(s)
