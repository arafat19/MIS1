...
class GetDropDownModulesTagLibActionService extends BaseService implements ActionIntf {
    ...
    public Object execute(Object parameters, Object obj) {
        try {
            ...
            String html = buildDropDown(moduleList, dropDownAttributes)
            return html
        } catch (Exception e) {
            log.error(e.message)
    ...
    private String buildDropDown(List moduleList, Map dropDownAttributes) {
        ...
        if (showHints.booleanValue()) {
            moduleList = Tools.listForKendoDropdown(moduleList, null, hintsText)
