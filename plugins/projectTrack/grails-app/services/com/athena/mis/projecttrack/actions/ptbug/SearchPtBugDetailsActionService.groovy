 ...
 * For details go through Use-Case doc named 'SearchPtBugDetailsActionService'
 */
class SearchPtBugDetailsActionService extends BaseService implements ActionIntf {
