<script type="text/javascript">
    ...
    function onLoadIssuePoPage() {
        initializeForm($("#filterPanelIssuePoForm"), onSubmitIssuePoFilterPanel);
        ...
        // update page title
        $(document).attr('title', "ARMS - Issue PO");
        loadNumberedMenu(MENU_ID_ARMS, "#rmsInstrument/showForIssuePo");
    }
    ...
    function onSubmitIssuePoFilterPanel() {
    ...
    function downloadIssuePo() {
        ...
        if (confirm('Do you want to download the CSV now?')) {
            ...
            var currentStatus = dropDownTaskStatus.value();
            var params = "?exhHouseId=" + exhHouseId + "&taskListId=" + taskListId + "&fromDate=" + fromDate + "&toDate=" + toDate + "&currentStatus=" + currentStatus + "&process=" + process + "&instrument=" + instrument;
            var url = "${createLink(controller: 'rmsInstrument', action: 'downloadTaskReportForIssuePo')}" + params;
