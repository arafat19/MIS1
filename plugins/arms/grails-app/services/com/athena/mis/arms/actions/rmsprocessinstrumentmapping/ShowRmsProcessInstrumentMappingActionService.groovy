 ...
 * For details go through Use-Case doc named 'ShowRmsProcessInstrumentMappingActionService'
 */
class ShowRmsProcessInstrumentMappingActionService extends BaseService implements ActionIntf {
    ...
    private static final String DEFAULT_FAILURE_MSG_SHOW_PRO_INS_MAPPING = "Failed to load process instrument mapping page"
    ...
    Object execute(Object parameters, Object obj) {
        ...
        try {
            ...
            List<GroovyRowResult> lstProInsMapping = list(this)          // get list of ProcessInstrumentMapping from DB
            ...
            result.put(Tools.MESSAGE, DEFAULT_FAILURE_MSG_SHOW_PRO_INS_MAPPING)
            return result
        }
    }
    ...
    Object buildSuccessResultForUI(Object obj) {
        ...
        try {
            ...
            Map gridObj = [page: pageNumber, total: count, rows: lstWrappedProInsMapping]
            result.put(Tools.IS_ERROR, Boolean.FALSE)
